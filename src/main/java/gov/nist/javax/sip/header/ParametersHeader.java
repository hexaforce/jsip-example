 ...
 *
 */
public abstract class ParametersHeader extends SIPHeader implements javax.sip.header.Parameters, ParametersExt, Serializable {
	 ...
	 *
	 * @return value of the parameter as a URI or null if the parameter not present.
	 */
	 ...
	 * 
	 * Example: P-Charging-Function-Addresses: ccf=[5555::b99:c88:d77:e66]; ccf=[5555::a55:b44:c33:d22]; ecf=[5555::1ff:2ee:3dd:4cc]; ecf=[5555::6aa:7bb:8cc:9dd]
	 * 
	...
	protected final boolean equalParameters(Parameters other) {
		...
		for (Iterator i = this.getParameterNames(); i.hasNext();) {
			...
			if (p1 == null ^ p2 == null)
				return false;
			else if (p1 != null && !p1.equalsIgnoreCase(p2))
				return false;
		}
