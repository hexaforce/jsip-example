...
/*
 * $Log: not supported by cvs2svn $ Revision 1.6 2009/09/15 02:55:26 mranga Issue number: 222 Add HeaderFactoryExt.createStatusLine(String) and HeaderFactoryExt.createRequestLine(String) Allows users to easily parse SipFrag bodies (for example NOTIFY bodies during call transfer).
 *
 * Revision 1.5 2009/07/17 18:57:38 emcho Converts indentation tabs to spaces so that we have a uniform indentation policy in the whole project.
 *
 * Revision 1.4 2006/07/13 09:01:48 mranga Issue number: Obtained from: Submitted by: jeroen van bemmel Reviewed by: mranga Moved some changes from jain-sip-1.2 to java.net
 *
