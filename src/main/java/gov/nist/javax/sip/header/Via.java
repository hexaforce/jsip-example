...
public class Via extends ParametersHeader implements javax.sip.header.ViaHeader, ViaHeaderExt {
	 ...
	 * comment field
	 *
	 * JvB note: RFC3261 does not allow a comment to appear in Via headers, and this is not accessible through the API. Suggest removal
	 */
	 ...
	 */
	public Hop getHop() {
		HopImpl hop = new HopImpl(sentBy.getHost().getHostname(), sentBy.getPort(), sentProtocol.getTransport());
		return hop;
	}
	...
	/**
	 * Sets the value of the transport. This parameter specifies which transport protocol to use for sending requests and responses to this entity. The following values are defined: "udp", "tcp", "sctp", "tls", "ws", "wss" but other values may be used also.
	 *
