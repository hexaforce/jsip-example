...
public abstract class AuthenticationHeader extends ParametersHeader {
	 ...
	 *
	 * @param challenge -- the challenge from which the parameters are extracted.
	 */
	...
	/**
	 * Sets the URI of the WWWAuthenicateHeader to the <var>uri</var> parameter value.
	 *
	 * @param uri - the new URI of this AuthenicationHeader.
	 * @since v1.1
	 *
	 *        Note that since 1.2 this is no longer applicable to the WWW-Authenticate and Proxy-Authenticate headers
	 */
	 ...
	 * @throws ParseException which signals that an error has been reached unexpectedly while parsing the domain.
	 * @since v1.1
	 */
	 ...
	 *
	 * @param stale - the Boolean.valueOf value of the stale parameter.
	 * @since v1.1
	 */
