...
public final class AuthenticationInfo extends ParametersHeader implements javax.sip.header.AuthenticationInfoHeader {
	 ...
	 *
	 * @param name is the name for which we want to retrieve the name value list.
	 */
	...
	/**
	 * Sets the CNonce of the AuthenticationInfoHeader to the <var>cNonce</var> parameter value.
	 *
	...
	/**
	 * Sets the NextNonce of the AuthenticationInfoHeader to the <var>nextNonce</var> parameter value.
	 *
	 * @param nextNonce - the new nextNonce String of this AuthenticationInfoHeader.
	 * @throws ParseException which signals that an error has been reached unexpectedly while parsing the nextNonce value.
	 * @since v1.1
	 */
	...
	/**
	 * Sets the Nonce Count of the AuthenticationInfoHeader to the <var>nonceCount</var> parameter value.
	 *
	...
	/**
	 * Sets the Qop value of the AuthenticationInfoHeader to the new <var>qop</var> parameter value.
	 *
	...
	/**
	 * Sets the Response of the AuthenticationInfoHeader to the new <var>response</var> parameter value.
	 *
	...
	/**
	 * Sets the SNum of the AuthenticationInfoHeader to the <var>sNum</var> parameter value.
	 *
	 * @param sNum - the new sNum String of this AuthenticationInfoHeader.
	 * @throws ParseException which signals that an error has been reached unexpectedly while parsing the sNum value.
	 */
	...
	/**
	 * Sets the SRand of the AuthenticationInfoHeader to the <var>sRand</var> parameter value.
	 *
	 * @param sRand - the new sRand String of this AuthenticationInfoHeader.
	 * @throws ParseException which signals that an error has been reached unexpectedly while parsing the sRand value.
	 */
	...
	/**
	 * Sets the TargetName of the AuthenticationInfoHeader to the <var>targetName</var> parameter value.
	 *
	 * @param targetName - the new targetName String of this AuthenticationInfoHeader.
	 * @throws ParseException which signals that an error has been reached unexpectedly while parsing the targetName value.
	 */
	...
	/**
	 * Sets authentication scheme name of the AuthenticationInfoHeader to the <var>scheme</var> parameter value.
	 *
