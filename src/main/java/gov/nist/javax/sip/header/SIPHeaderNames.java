...
public interface SIPHeaderNames {
	...
	public static final String PROXY_AUTHENTICATE = ProxyAuthenticateHeader.NAME;
	// 20
	...
	public static final String PROXY_AUTHORIZATION = ProxyAuthorizationHeader.NAME;
	// 32
	...
	public static final String CONTENT_DISPOSITION = ContentDispositionHeader.NAME;
	// 35
	...
	public static final String AUTHENTICATION_INFO = AuthenticationInfoHeader.NAME;
	// 43
	...
	public static final String SUBSCRIPTION_STATE = SubscriptionStateHeader.NAME;
	// 48
