...
public class RequestLine extends SIPObject implements SipRequestLine {
	 ...
	 *
	 * @param other object to compare with. We assume that all fields are set.
	 */
...
/*
 * $Log: not supported by cvs2svn $ Revision 1.8 2009/09/15 02:55:27 mranga Issue number: 222 Add HeaderFactoryExt.createStatusLine(String) and HeaderFactoryExt.createRequestLine(String) Allows users to easily parse SipFrag bodies (for example NOTIFY bodies during call transfer).
 *
 * Revision 1.7 2009/07/17 18:57:36 emcho Converts indentation tabs to spaces so that we have a uniform indentation policy in the whole project.
 *
 * Revision 1.6 2007/02/12 15:19:23 belangery Changed the encode() and encodeBody() methods of SIP headers and basic classes to make them use the same StringBuilder instance during the encoding phase.
 *
 * Revision 1.5 2006/07/13 09:01:26 mranga Issue number: Obtained from: Submitted by: jeroen van bemmel Reviewed by: mranga Moved some changes from jain-sip-1.2 to java.net
 *
 ...
 *
 *
 * Revision 1.3 2005/04/16 20:38:50 dmuresan Canonical clone() implementations for the GenericObject and GenericObjectList hierarchies
 *
