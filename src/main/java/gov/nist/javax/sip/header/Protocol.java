...
public class Protocol extends SIPObject {
	...
	public StringBuilder encode(StringBuilder buffer) {
		buffer.append(Utils.toUpperCase(protocolName)).append(SLASH).append(protocolVersion).append(SLASH).append(transport.toUpperCase());
...
/*
 * $Log: not supported by cvs2svn $ Revision 1.8 2009/07/17 18:57:33 emcho Converts indentation tabs to spaces so that we have a uniform indentation policy in the whole project.
 *
 * Revision 1.7 2007/02/12 15:19:23 belangery Changed the encode() and encodeBody() methods of SIP headers and basic classes to make them use the same StringBuilder instance during the encoding phase.
 *
 * Revision 1.6 2006/07/13 09:01:24 mranga Issue number: Obtained from: Submitted by: jeroen van bemmel Reviewed by: mranga Moved some changes from jain-sip-1.2 to java.net
 *
 ...
 *
 * Revision 1.2 2005/10/09 18:47:53 jeroen defined equals() in terms of API calls
 *
