...
/*
 * $Log: not supported by cvs2svn $ Revision 1.3 2009/07/17 18:57:42 emcho Converts indentation tabs to spaces so that we have a uniform indentation policy in the whole project.
 *
 * Revision 1.2 2006/10/27 20:58:31 mranga Issue number: Obtained from: Submitted by: Reviewed by: mranga doc fixups CVS: ---------------------------------------------------------------------- CVS: Issue number: CVS: If this change addresses one or more issues, CVS: then enter the issue number(s) here. CVS: Obtained from: CVS: If this change has been taken from another system, CVS: then name the system in this line, otherwise delete it. CVS: Submitted by: CVS: If this code has been contributed to the project by someone else; i.e., CVS: they sent us a patch or a set of diffs, then include their name/email CVS: address here. If this is your work then delete this line. CVS: Reviewed by: CVS: If we are doing pre-commit code reviews and someone else has CVS: reviewed your changes, include their name(s) here. CVS: If you have not had it reviewed then delete this line.
 *
 * Revision 1.1 2006/10/12 11:57:51 pmusgrave Issue number: 79, 80 Submitted by: pmusgrave@newheights.com Reviewed by: mranga
 *
 * Revision 1.3 2006/07/19 15:05:20 pmusgrave Modify encodeBody so it uses callId and not CallIdentifier
 *
 * Revision 1.2 2006/04/17 23:41:31 pmusgrave Add Session Timer and Replaces headers
 *
 * Revision 1.1.1.1 2006/03/15 16:00:07 pmusgrave Source with additions
 *
 * Revision 1.3 2005/04/16 20:38:48 dmuresan Canonical clone() implementations for the GenericObject and GenericObjectList hierarchies
 *
