...
//        StringBuilder retval = new StringBuilder();
	...
	public float getTimeStamp() {
		return this.timeStampFloat == -1 ? Float.valueOf(timeStamp).floatValue() : this.timeStampFloat;
	}
	 ...
	 *
	 * @param delay - the Float.valueOf delay value
	 * @throws InvalidArgumentException if the delay value argumenmt is a negative value other than <code>-1</code>.
	 */
