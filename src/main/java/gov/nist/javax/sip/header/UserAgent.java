...
/*
 * $Log: not supported by cvs2svn $ Revision 1.8 2009/07/17 18:57:40 emcho Converts indentation tabs to spaces so that we have a uniform indentation policy in the whole project.
 *
 * Revision 1.7 2008/07/30 14:36:06 mranga Issue number: Obtained from: Submitted by: mranga Reviewed by: mranga Fix minor issue in encoding of user-agent header.
 *
 * Revision 1.6 2006/10/12 11:57:55 pmusgrave Issue number: 79, 80 Submitted by: pmusgrave@newheights.com Reviewed by: mranga
 *
 * Revision 1.5 2006/07/13 09:01:48 mranga Issue number: Obtained from: Submitted by: jeroen van bemmel Reviewed by: mranga Moved some changes from jain-sip-1.2 to java.net
 *
 ...
 *
 *
 * Revision 1.3 2005/04/16 20:38:51 dmuresan Canonical clone() implementations for the GenericObject and GenericObjectList hierarchies
 *
