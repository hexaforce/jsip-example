 ...
 * Require SIP Header.
 *
 * @version 1.2 $Revision: 1.6 $ $Date: 2010-05-06 14:07:48 $
 *
...
public class Require extends SIPHeader implements RequireHeader {
	...
	/**
	 * Sets the option tag value to the new supplied <var>optionTag</var> parameter.
	 *
...
/*
 * $Log: not supported by cvs2svn $ Revision 1.5 2009/07/17 18:57:36 emcho Converts indentation tabs to spaces so that we have a uniform indentation policy in the whole project.
 *
 * Revision 1.4 2006/07/13 09:01:22 mranga Issue number: Obtained from: Submitted by: jeroen van bemmel Reviewed by: mranga Moved some changes from jain-sip-1.2 to java.net
 *
