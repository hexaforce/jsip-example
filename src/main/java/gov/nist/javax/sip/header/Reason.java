...
/*
 * $Log: not supported by cvs2svn $ Revision 1.8 2009/10/18 13:46:34 deruelle_jean FindBugs Fixes (Category Performance Warnings)
 *
 * Issue number: Obtained from: Submitted by: Jean Deruelle Reviewed by:
 *
 * Revision 1.7 2009/07/17 18:57:35 emcho Converts indentation tabs to spaces so that we have a uniform indentation policy in the whole project.
 *
 * Revision 1.6 2008/11/19 10:56:27 jbemmel Ensure that reason text is quoted
 *
 * Revision 1.5 2006/11/01 02:22:56 mranga Issue number: 83 Obtained from: Submitted by: Reviewed by: mranga fix thread safety issue in NameValueList and clean up some mess. CVS: ---------------------------------------------------------------------- CVS: Issue number: CVS: If this change addresses one or more issues, CVS: then enter the issue number(s) here. CVS: Obtained from: CVS: If this change has been taken from another system, CVS: then name the system in this line, otherwise delete it. CVS: Submitted by: CVS: If this code has been contributed to the project by someone else; i.e., CVS: they sent us a patch or a set of diffs, then include their name/email CVS: address here. If this is your work then delete this line. CVS: Reviewed by: CVS: If we are doing pre-commit code reviews and someone else has CVS: reviewed your changes, include their name(s) here. CVS: If you have not had it reviewed then delete this line.
 *
 * Revision 1.4 2006/07/13 09:01:19 mranga Issue number: Obtained from: Submitted by: jeroen van bemmel Reviewed by: mranga Moved some changes from jain-sip-1.2 to java.net
 *
