...
public class HeaderFactoryImpl implements HeaderFactory, HeaderFactoryExt {
	 ...
	 * @throws ParseException which signals that an error has been reached unexpectedly while parsing the encoding value.
	 ...
	 * @throws ParseException which signals that an error has been reached unexpectedly while parsing the content type or content subtype value.
	 ...
	 * @throws ParseException which signals that an error has been reached unexpectedly while parsing the eventType value.
	 ...
	 * @throws ParseException which signals that an error has been reached unexpectedly while parsing the method value.
	 ...
	 * @throws ParseException which signals that an error has been reached unexpectedly while parsing the response value.
	 ...
	 * @throws ParseException which signals that an error has been reached unexpectedly while parsing the scheme value.
	 ...
	 * @throws InvalidArgumentException if supplied sequence number is less than zero.
	 * @throws ParseException           which signals that an error has been reached unexpectedly while parsing the method value.
	 ...
	 * @throws ParseException which signals that an error has been reached unexpectedly while parsing the contentDisposition value.
	 ...
	 * @throws InvalidArgumentException if supplied contentLength is less than zero.
	 ...
	 * @throws InvalidArgumentException if supplied expires is less than zero.
	 * @return the newly created ExpiresHeader object.
	 */
	public ExpiresHeader createExpiresHeader(long expires) throws InvalidArgumentException {
	 ...
	 * @throws ParseException which signals that an error has been reached unexpectedly while parsing the name or value values.
	 * @return the newly created ExtensionHeader object.
	 */
	public javax.sip.header.ExtensionHeader createExtensionHeader(String name, String value) throws ParseException {
		if (name == null)
	 ...
	 * @throws ParseException which signals that an error has been reached unexpectedly while parsing the tag value.
	 ...
	 * @throws InvalidArgumentException if supplied maxForwards is less than zero or greater than 255.
	 ...
	 * @throws InvalidArgumentException if supplied mimeVersion is less than zero.
	 ...
	 * @throws InvalidArgumentException if supplied minExpires is less than zero.
	 * @return the newly created MinExpiresHeader object.
	 * @since v1.1
	 */
	public MinExpiresHeader createMinExpiresHeader(long minExpires) throws InvalidArgumentException {
	 ...
	 * @return the newly created ExpiresHeader object.
	 *
	 *         TODO: Once interfaces are in javax, change the type to MinSEHeader and add to HeaderFactory. - pmusgrave
	 *
	 *         pmusgrave
	 */
	 ...
	 * @throws ParseException which signals that an error has been reached unexpectedly while parsing the organization value.
	 ...
	 * @throws ParseException which signals that an error has been reached unexpectedly while parsing the priority value.
	 ...
	 * @throws ParseException which signals that an error has been reached unexpectedly while parsing the optionTag value.
	 */
	 ...
	 * @param method     - the new string value of the method.
	 * @throws InvalidArgumentException if supplied rSeqNumber or cSeqNumber is less than zero or greater than than 2**31-1.
	 * @throws ParseException           which signals that an error has been reached unexpectedly while parsing the method value.
	 ...
	 * @throws InvalidArgumentException if supplied sequenceNumber is less than zero or greater than than 2**31-1.
	 ...
	 * @throws ParseException which signals that an error has been reached unexpectedly while parsing the List of optionTag value.
	 ...
	 * @throws InvalidArgumentException if supplied retryAfter is less than zero.
	 ...
	 * @throws ParseException which signals that an error has been reached unexpectedly while parsing the product value.
	 ...
	 * @throws ParseException which signals that an error has been reached unexpectedly while parsing the subject value.
	 ...
	 * @throws ParseException which signals that an error has been reached unexpectedly while parsing the subscriptionState value.
	 ...
	 * @throws InvalidArgumentException if supplied timeStamp is less than zero.
	 ...
	 * @throws ParseException which signals that an error has been reached unexpectedly while parsing the branch value.
	 ...
	 *
	 * @param scheme - the new string value of the scheme.
	 * @throws ParseException which signals that an error has been reached unexpectedly while parsing the scheme values.
	 ...
	 * @throws ParseException           which signals that an error has been reached unexpectedly while parsing the agent or comment values.
	 * @throws InvalidArgumentException if an invalid integer code is given for the WarningHeader.
	 ...
	 */
	public javax.sip.header.Header createHeader(String headerName, String headerValue) throws java.text.ParseException {
		if (headerName == null)
			throw new NullPointerException("header name is null");
		String hdrText = new StringBuilder().append(headerName).append(":").append(headerValue).toString();
	 ...
	 * @throws ParseException -- if a parse exception occurs or a List of that type of header is not alowed.
	 ...
	 *
	 * TODO: Once interfaces are in javax, change the type to MinSEHeader and add to HeaderFactory. - pmusgrave pmusgrave
	 */
	...
	/**
	 * @return the newly create P-User-Database header. Please note that this is not a SIP/TEL uri. It is a DIAMETER AAA URI.
	 */
