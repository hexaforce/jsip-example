 ...
 *
 * The following new stack initialization flags are defined (not the gov.nist prefix will be dropped when the spec is updated):
 *
 * <ul>
...
public interface SipStackExt extends SipStack {
	 ...
	 *
	 * @return Dialog object matching the Replaces header, provided it is in an appropriate state to be replaced, <code>null</code> otherwise
	 *
	 * @since 2.0
	 */
	 ...
	 *
	 * @return - the authentication helper which can be used for generating the appropriate headers for handling authentication challenges for user agents.
	 *
	 * @since 2.0
	 */
	 ...
	 *
	 * @return Dialog object matching the Join header, provided it is in an appropriate state to be replaced, <code>null</code> otherwise
	 *
	 * @since 2.0
	 */
	 ...
	 *
	 * @return the local SocketAddress that this handler would use when connecting to the specified destination address and port.
	 *
