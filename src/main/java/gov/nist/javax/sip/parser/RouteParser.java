...
public class RouteParser extends AddressParametersParser {
	...
	/**
	 * public static void main(String args[]) throws ParseException { String rou[] = { "Route: <sip:alice@atlanta.com>\n", "Route: sip:bob@biloxi.com \n", "Route: sip:alice@atlanta.com, sip:bob@biloxi.com, sip:carol@chicago.com\n" };
	 * 
	 * for (int i = 0; i < rou.length; i++ ) { RouteParser rp = new RouteParser(rou[i]); RouteList routeList = (RouteList) rp.parse(); System.out.println("encoded = " +routeList.encode()); }
	 * 
	 * }
	 * 
	 */
...
/*
 * $Log: not supported by cvs2svn $ Revision 1.7 2007/02/06 16:40:03 belangery Introduced simple code optimizations.
 *
 * Revision 1.6 2006/07/13 09:02:07 mranga Issue number: Obtained from: Submitted by: jeroen van bemmel Reviewed by: mranga Moved some changes from jain-sip-1.2 to java.net
 *
