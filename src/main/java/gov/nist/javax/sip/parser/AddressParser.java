...
/*
 * $Log: not supported by cvs2svn $ Revision 1.11 2009/10/22 10:26:27 jbemmel Fix for issue #230, restructured the code such that parsing for any address appearing without '<' '>' stops at ';', then parameters are assigned to the header as expected
 *
 * Revision 1.10 2009/07/17 18:57:57 emcho Converts indentation tabs to spaces so that we have a uniform indentation policy in the whole project.
 *
 * Revision 1.9 2007/02/12 15:19:26 belangery Changed the encode() and encodeBody() methods of SIP headers and basic classes to make them use the same StringBuilder instance during the encoding phase.
 *
 * Revision 1.8 2007/02/06 16:40:02 belangery Introduced simple code optimizations.
 *
 * Revision 1.7 2006/07/13 09:01:57 mranga Issue number: Obtained from: Submitted by: jeroen van bemmel Reviewed by: mranga Moved some changes from jain-sip-1.2 to java.net
 *
 ...
 *
 * Revision 1.3 2006/06/16 15:26:28 mranga Added NIST disclaimer to all public domain files. Clean up some javadoc. Fixed a leak
 *
 * Revision 1.2 2006/03/08 23:32:54 mranga *** empty log message ***
 *
 ...
 *
 *
 * Revision 1.5 2004/07/28 14:13:54 mranga Submitted by: mranga
 *
 * Move out the test code to a separate test/unit class. Fixed some encode methods.
 *
