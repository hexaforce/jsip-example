...
/*
 * $Log: not supported by cvs2svn $ Revision 1.12 2009/07/17 18:58:06 emcho Converts indentation tabs to spaces so that we have a uniform indentation policy in the whole project.
 *
 * Revision 1.11 2009/05/10 00:29:53 mranga
 *
 * Submitted by: Aayush Bhatnagar Reviewed by: IMS headers and parsers.
 *
 * Revision 1.10 2009/01/22 19:33:47 deruelle_jean Add support for JOIN (RFC 3911) Issue number: 186 Obtained from: Submitted by: Jean Deruelle Reviewed by: Ranga, The high priest and grand poobah of Jain-SIP
 *
 * Revision 1.9 2007/01/08 19:24:22 mranga Issue number: Obtained from: Submitted by: Miguel Freitas Reviewed by: mranga
 *
 ...
 *
 * Revision 1.8 2006/10/12 11:57:54 pmusgrave Issue number: 79, 80 Submitted by: pmusgrave@newheights.com Reviewed by: mranga
 *
 ...
 *
 * Revision 1.6 2006/07/13 09:01:55 mranga Issue number: Obtained from: Submitted by: jeroen van bemmel Reviewed by: mranga Moved some changes from jain-sip-1.2 to java.net
 *
 * CVS: ---------------------------------------------------------------------- CVS: Issue number: CVS: If this change addresses one or more issues, CVS: then enter the issue number(s) here. CVS: Obtained from: CVS: If this change has been taken from another system, CVS: then name the system in this line, otherwise delete it. CVS: Submitted by: CVS: If this code has been contributed to the project by someone else; i.e., CVS: they sent us a patch or a set of diffs, then include their name/email CVS: address here. If this is your work then delete this line. CVS: Reviewed by: CVS: If we are doing pre-commit code reviews and someone else has CVS: reviewed your changes, include their name(s) here. CVS: If you have not had it reviewed then delete this line.
 *
 ...
 *
 * Revision 1.2 2005/10/27 20:49:00 jeroen added support for RFC3903 PUBLISH
 *
