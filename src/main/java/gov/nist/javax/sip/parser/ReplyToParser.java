...
public class ReplyToParser extends AddressParametersParser {
	...
	/**
	 * public static void main(String args[]) throws ParseException { String r[] = { "Reply-To: Bob <sip:bob@biloxi.com>\n" };
	 * 
	 * for (int i = 0; i < r.length; i++ ) { ReplyToParser rt = new ReplyToParser(r[i]); ReplyTo re = (ReplyTo) rt.parse(); System.out.println("encoded = " +re.encode()); }
	 * 
	 * }
	 */
}
/*
 * $Log: not supported by cvs2svn $ Revision 1.6 2006/07/13 09:02:16 mranga Issue number: Obtained from: Submitted by: jeroen van bemmel Reviewed by: mranga Moved some changes from jain-sip-1.2 to java.net
 *
