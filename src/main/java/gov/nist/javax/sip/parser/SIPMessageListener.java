...
public interface SIPMessageListener extends ParseExceptionListener {
	 ...
	 * 
	 * @see ParseExceptionListener for the method that gets called on parse exception.
 ...
 *
 *
 * Revision 1.5 2004/02/29 00:46:34 mranga Reviewed by: mranga Added new configuration property to limit max message size for TCP transport. The property is gov.nist.javax.sip.MAX_MESSAGE_SIZE
 *
