...
/*
 * $Log: not supported by cvs2svn $ Revision 1.17 2010/01/12 00:05:25 mranga Add support for References header draft-worley-references-05
 *
 * Revision 1.16 2009/07/17 18:58:01 emcho Converts indentation tabs to spaces so that we have a uniform indentation policy in the whole project.
 *
 * Revision 1.15 2009/01/22 19:33:48 deruelle_jean Add support for JOIN (RFC 3911) Issue number: 186 Obtained from: Submitted by: Jean Deruelle Reviewed by: Ranga, The high priest and grand poobah of Jain-SIP
 *
 * Revision 1.14 2007/03/07 14:29:46 belangery Yet another bunch of improvements in the parsing code.
 *
 * Revision 1.13 2007/02/23 14:56:06 belangery Added performance improvement around header name lowercase conversion.
 *
 * Revision 1.12 2007/01/08 19:24:21 mranga Issue number: Obtained from: Submitted by: Miguel Freitas Reviewed by: mranga
 *
 ...
 *
 * Revision 1.11 2006/10/12 11:57:54 pmusgrave Issue number: 79, 80 Submitted by: pmusgrave@newheights.com Reviewed by: mranga
 *
 * Revision 1.10 2006/09/29 19:40:50 jbemmel fixed missing IMS header parsing plumbing
 *
 * Revision 1.9 2006/09/11 18:41:32 mranga Issue number: Obtained from: Submitted by: mranga Reviewed by: Tighter integration of IMS headers. CVS: ---------------------------------------------------------------------- CVS: Issue number: CVS: If this change addresses one or more issues, CVS: then enter the issue number(s) here. CVS: Obtained from: CVS: If this change has been taken from another system, CVS: then name the system in this line, otherwise delete it. CVS: Submitted by: CVS: If this code has been contributed to the project by someone else; i.e., CVS: they sent us a patch or a set of diffs, then include their name/email CVS: address here. If this is your work then delete this line. CVS: Reviewed by: CVS: If we are doing pre-commit code reviews and someone else has CVS: reviewed your changes, include their name(s) here. CVS: If you have not had it reviewed then delete this line.
 *
 * Revision 1.8 2006/08/15 21:44:50 mranga Issue number: Obtained from: Submitted by: mranga Reviewed by: mranga Incorporating the latest API changes from Phelim CVS: ---------------------------------------------------------------------- CVS: Issue number: CVS: If this change addresses one or more issues, CVS: then enter the issue number(s) here. CVS: Obtained from: CVS: If this change has been taken from another system, CVS: then name the system in this line, otherwise delete it. CVS: Submitted by: CVS: If this code has been contributed to the project by someone else; i.e., CVS: they sent us a patch or a set of diffs, then include their name/email CVS: address here. If this is your work then delete this line. CVS: Reviewed by: CVS: If we are doing pre-commit code reviews and someone else has CVS: reviewed your changes, include their name(s) here. CVS: If you have not had it reviewed then delete this line.
 *
 * Revision 1.7 2006/07/13 09:02:06 mranga Issue number: Obtained from: Submitted by: jeroen van bemmel Reviewed by: mranga Moved some changes from jain-sip-1.2 to java.net
 *
 * CVS: ---------------------------------------------------------------------- CVS: Issue number: CVS: If this change addresses one or more issues, CVS: then enter the issue number(s) here. CVS: Obtained from: CVS: If this change has been taken from another system, CVS: then name the system in this line, otherwise delete it. CVS: Submitted by: CVS: If this code has been contributed to the project by someone else; i.e., CVS: they sent us a patch or a set of diffs, then include their name/email CVS: address here. If this is your work then delete this line. CVS: Reviewed by: CVS: If we are doing pre-commit code reviews and someone else has CVS: reviewed your changes, include their name(s) here. CVS: If you have not had it reviewed then delete this line.
 *
 * Revision 1.5 2006/06/19 06:47:27 mranga javadoc fixups
 *
 * Revision 1.4 2006/06/16 15:26:28 mranga Added NIST disclaimer to all public domain files. Clean up some javadoc. Fixed a leak
 *
 * Revision 1.3 2005/10/27 20:49:00 jeroen added support for RFC3903 PUBLISH
 *
 * Revision 1.2 2005/10/14 19:59:00 jeroen bugfix: missing parser for shortform of Subject (s)
 *
 ...
 *
 *
 * Revision 1.4 2005/04/04 09:29:03 dmuresan Replaced new String().getClass() with String.class.
 *
 * Revision 1.3 2004/01/22 13:26:31 sverker Issue number: Obtained from: Submitted by: sverker Reviewed by: mranga
 *
