...
public class ToParser extends AddressParametersParser {
	...
	/**
	 * 
	 * public static void main(String args[]) throws ParseException { String to[] = { "To: <sip:+1-650-555-2222@ss1.wcom.com;user=phone>;tag=5617\n", "To: T. A. Watson <sip:watson@bell-telephone.com;param=something>\n", "To: LittleGuy <sip:UserB@there.com;tag=foo>;tag=bar\n", "To: sip:mranga@120.6.55.9\n", "To: sip:mranga@129.6.55.9;tag=696928473514.129.6.55.9\n", "To: sip:mranga@129.6.55.9; tag=696928473514.129.6.55.9\n", "To: sip:mranga@129.6.55.9 ;tag=696928473514.129.6.55.9\n", "To: sip:mranga@129.6.55.9 ; tag=696928473514.129.6.55.9\n" };
	 * 
	 * for (int i = 0; i < to.length; i++ ) { System.out.println("toParse = " + to[i]); ToParser tp = new ToParser(to[i]); To t = (To) tp.parse(); System.out.println("encoded = " + t.encode()); }
	 * 
	 * }
	 **/
}
/*
 * $Log: not supported by cvs2svn $ Revision 1.10 2009/07/17 18:58:06 emcho Converts indentation tabs to spaces so that we have a uniform indentation policy in the whole project.
 *
 * Revision 1.9 2007/10/23 17:34:55 mranga Issue number: Obtained from: Submitted by: mranga Reviewed by: mranga
 *
 * Refactored header collections.
 *
 * Revision 1.8 2006/07/13 09:02:00 mranga Issue number: Obtained from: Submitted by: jeroen van bemmel Reviewed by: mranga Moved some changes from jain-sip-1.2 to java.net
 *
 ...
 *
 *
 * Revision 1.6 2004/04/22 22:51:18 mranga Submitted by: Thomas Froment Reviewed by: mranga
 *
 * Fixed corner cases.
 *
