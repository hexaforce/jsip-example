...
public class ProxyAuthorizationParser extends ChallengeParser {
	...
	/**
	 * 
	 * public static void main(String args[]) throws ParseException { String paAuth[] = { "Proxy-Authorization: Digest realm=\"MCI WorldCom SIP\","+ "domain=\"sip:ss2.wcom.com\",nonce=\"ea9c8e88df84f1cec4341ae6cbe5a359\","+ "opaque=\"\",stale=FALSE,algorithm=MD5\n",
	 * 
...
/*
 * $Log: not supported by cvs2svn $ Revision 1.6 2006/07/13 09:02:18 mranga Issue number: Obtained from: Submitted by: jeroen van bemmel Reviewed by: mranga Moved some changes from jain-sip-1.2 to java.net
 *
 ...
 *
 *
 * Revision 1.4 2005/02/24 16:13:11 mranga Submitted by: mranga Reviewed by: mranga Just some additional testing on the parser.
 *
