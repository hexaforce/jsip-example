...
/*
 * $Log: not supported by cvs2svn $ Revision 1.11 2009/07/17 18:58:00 emcho Converts indentation tabs to spaces so that we have a uniform indentation policy in the whole project.
 *
 * Revision 1.10 2007/10/23 17:34:55 mranga Issue number: Obtained from: Submitted by: mranga Reviewed by: mranga
 *
 * Refactored header collections.
 *
 * Revision 1.9 2006/07/13 09:02:16 mranga Issue number: Obtained from: Submitted by: jeroen van bemmel Reviewed by: mranga Moved some changes from jain-sip-1.2 to java.net
 *
 ...
 *
 *
 * Revision 1.7 2004/08/10 21:35:44 mranga Reviewed by: mranga move test cases out to another package
 *
 * Revision 1.6 2004/04/22 22:51:17 mranga Submitted by: Thomas Froment Reviewed by: mranga
 *
 * Fixed corner cases.
 *
