...
/*
 * $Log: not supported by cvs2svn $ Revision 1.10 2009/09/15 02:55:27 mranga Issue number: 222 Add HeaderFactoryExt.createStatusLine(String) and HeaderFactoryExt.createRequestLine(String) Allows users to easily parse SipFrag bodies (for example NOTIFY bodies during call transfer).
 *
 * Revision 1.9 2009/07/17 18:58:03 emcho Converts indentation tabs to spaces so that we have a uniform indentation policy in the whole project.
 *
 * Revision 1.8 2006/07/13 09:02:14 mranga Issue number: Obtained from: Submitted by: jeroen van bemmel Reviewed by: mranga Moved some changes from jain-sip-1.2 to java.net
 *
 ...
 *
 *
 * Revision 1.6 2004/10/28 19:02:50 mranga Submitted by: Daniel Martinez Reviewed by: M. Ranganathan
 *
 * Added changes for TLS support contributed by Daniel Martinez
 *
 * Revision 1.5 2004/06/27 00:41:51 mranga Submitted by: Thomas Froment and Pierre De Rop Reviewed by: mranga Performance improvements (auxiliary data structure for fast lookup of transactions).
 *
