...
public interface ParseExceptionListener {
	 ...
	 * <li>2. Ignoring the header (attach the unparseable header to the SIPMessage being parsed).
...
/*
 * $Log: not supported by cvs2svn $ Revision 1.6 2006/07/13 09:01:55 mranga Issue number: Obtained from: Submitted by: jeroen van bemmel Reviewed by: mranga Moved some changes from jain-sip-1.2 to java.net
 *
