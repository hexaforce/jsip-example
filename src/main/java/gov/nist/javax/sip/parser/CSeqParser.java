 ...
 * 
 * @version 1.2 $Revision: 1.11 $ $Date: 2010-05-06 14:07:45 $
 * 
 ...
 *
 * Revision 1.3 2006/05/22 08:16:15 mranga Added tests for retransmissionAlert flag Added tests for transaction terminated event
 *
 * Revision 1.2 2006/04/17 17:45:01 jeroen - Using SIPRequest method to canonicalize request name (current code was omitting some)
 *
 ...
 *
 *
 * Revision 1.7 2005/04/27 14:12:04 mranga Submitted by: Mario Mantak Reviewed by: mranga
 *
 * Added a missing "short form" for event header.
 *
 * Revision 1.6 2005/04/21 00:01:59 mranga Issue number: Obtained from: Submitted by: mranga Reviewed by: mranga
 *
