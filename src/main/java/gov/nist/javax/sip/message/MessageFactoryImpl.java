...
public class MessageFactoryImpl implements MessageFactory, MessageFactoryExt {
	 ...
	 * @param contentType - the new ContentTypeHeader object of the content type value of this Message.
	 * @throws ParseException which signals that an error has been reached unexpectedly while parsing the method or the body.
	 */
	public Request createRequest(javax.sip.address.URI requestURI, String method, CallIdHeader callId, CSeqHeader cSeq, FromHeader from, ToHeader to, List via, MaxForwardsHeader maxForwards, ContentTypeHeader contentType, Object content) throws ParseException {
	 ...
	 * @param to         - the new ToHeader object of the to value of this Message.
	 * @param via        - the new List object of the ViaHeaders of this Message.
	 * @throws ParseException which signals that an error has been reached unexpectedly while parsing the method.
	 */
	 ...
	 * @param content     - the new Object of the body content value of this Message.
	 * @param contentType - the new ContentTypeHeader object of the content type value of this Message.
	 * @throws ParseException which signals that an error has been reached unexpectedly while parsing the statusCode or the body.
	 */
	 ...
	 * @param to         - the new ToHeader object of the to value of this Message.
	 * @param via        - the new List object of the ViaHeaders of this Message.
	 * @throws ParseException which signals that an error has been reached unexpectedly while parsing the statusCode.
	 */
	 ...
	 * @throws ParseException which signals that an error has been reached unexpectedly while parsing the method or the body.
	 */
	public Request createRequest(javax.sip.address.URI requestURI, String method, CallIdHeader callId, CSeqHeader cSeq, FromHeader from, ToHeader to, List via, MaxForwardsHeader maxForwards, ContentTypeHeader contentType, byte[] content) throws ParseException {
		if (requestURI == null || method == null || callId == null || cSeq == null || from == null || to == null || via == null || maxForwards == null || content == null || contentType == null)
	 ...
	 *
	 * @param requestString -- string from which to create the message null string returns an empty message.
	 */
...
//        smp.setStrict(this.strict);
		...
		/*
		 * This allows you to catch parse exceptions and create invalid messages if you want.
		 */
	 ...
	 *
	 * @param responseString -- string from which to create the message null string returns an empty message.
	 *
	 */
