 ...
 *
 */
public class SIPResponse extends SIPMessage implements javax.sip.message.Response, ResponseExt {
...
//        String retval;
	 ...
	 * 
	 * @return LinkedList containing encoded strings for each header in the message.
	 */
	 ...
	 * 
	 * @param matchObj template object to match ourselves with (null in any position in the template object matches wildcard)
	 */
