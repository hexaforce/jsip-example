...
public class SipUri extends GenericURI implements javax.sip.address.SipURI, SipURIExt {
	 ...
	 *
	 *         JvB: Updated to define equality in terms of API methods, according to the rules in RFC3261 section 19.1.4
	 *
	 *         Jean Deruelle: Updated to define equality of API methods, according to the rules in RFC3261 section 19.1.4 convert potential ie : %HEX HEX encoding parts of the URI before comparing them transport param added in comparison header equality enforced in comparison
	 *
	 */
	 ...
	 * 
	 * @return Get the query headers (that appear after the ? in the URL)
	 */
	 ...
	 * 
	 * @return User password when it embedded as part of the uri ( a very bad idea).
	 */
	 ...
	 * 
	 * @return TelephoneNumber part of the url (only makes sense when user = phone is specified)
	 */
	 ...
	 * 
	 * @return get the host:port part of the url parsed into a structure.
	 */
	...
	public String getHost() {
		if (authority == null)
			return null;
		else if (authority.getHost() == null)
			return null;
		else
	...
	/**
	 * Sets the value of the "transport" parameter. This parameter specifies which transport protocol to use for sending requests and responses to this entity. The following values are defined: "udp", "tcp", "sctp", "tls", "ws", "wss" but other values may be used also. This method is equivalent to setParameter("transport", transport). Transport parameter constants are defined in the {@link javax.sip.ListeningPoint}.
	 *
	...
	public void setTransportParam(String transport) throws ParseException {
		...
		/*
		 * if (transport.compareToIgnoreCase("UDP") == 0 || transport.compareToIgnoreCase("TLS") == 0 || transport.compareToIgnoreCase("TCP") == 0 || transport.compareToIgnoreCase("SCTP") == 0 || transport.compareToIgnoreCase(ListeningPointExt.WS) == 0 || transport.compareToIgnoreCase(ListeningPointExt.WSS) == 0) {
		 */
