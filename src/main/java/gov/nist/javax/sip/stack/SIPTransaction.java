...
public interface SIPTransaction extends TransactionExt {
	 ...
	 * 
	 * @param newBranch New string used as the branch for this transaction.
	 */
	 ...
	 * 
	 * @param sipDialog -- the dialog to set.
	 * @param dialogId  -- the dialog id ot associate with the dialog.s
	 */
	 ...
	 * 
	 * @return the last response received (for client transactions) or sent (for server transactions).
	 */
	 ...
	 * 
	 * @param applicationData -- application data pointer to set. null clears the applicationd data pointer.
	 * 
	 */
