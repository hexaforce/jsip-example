...
public class NioTlsWebSocketMessageChannel extends NioWebSocketMessageChannel implements NioTlsChannelInterface {
	...
	public static NioTlsWebSocketMessageChannel create(NioTlsWebSocketMessageProcessor nioTcpMessageProcessor, SocketChannel socketChannel) throws IOException {
	...
	public void init(boolean clientMode) throws Exception, CertificateException, FileNotFoundException, IOException {
		SSLContext ctx = clientMode ? ((NioTlsWebSocketMessageProcessor) messageProcessor).sslClientCtx : ((NioTlsWebSocketMessageProcessor) messageProcessor).sslServerCtx;
		...
		String clientProtocols = ((SipStackImpl) super.sipStack).getConfigurationProperties().getProperty("gov.nist.javax.sip.TLS_CLIENT_PROTOCOLS");
	...
	@Override
	public void sendMessage(final SIPMessage sipMessage, final InetAddress receiverAddress, final int receiverPort) throws IOException {
	...
	public void sendHttpMessage(final byte message[], final InetAddress receiverAddress, final int receiverPort, final boolean retry) throws IOException {
		checkSocketState();
