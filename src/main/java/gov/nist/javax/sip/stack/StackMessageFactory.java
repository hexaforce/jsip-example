...
public interface StackMessageFactory {
	 ...
	 * @param serverTransaction is the message channel on which this request was received.
	 */
	 ...
	 * @param serverTransaction is the message channel on which the response was received.
	 */
