...
public final class HopImpl extends Object implements javax.sip.address.Hop, Serializable {
	...
	HopImpl(String hop) throws IllegalArgumentException {
		...
		/*
		 * if (transport.compareToIgnoreCase("UDP") != 0 && transport.compareToIgnoreCase("TLS") != 0 && transport.compareToIgnoreCase("TCP") != 0) { System.err.println("Bad transport string " + transport); throw new IllegalArgumentException(hop); }
		 */
	}
