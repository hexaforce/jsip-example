...
public abstract class MessageProcessor {
	 ...
	 *
	 * @return the port for this message processor. This is where you receive messages.
	 */
	public int getPort() {
		return this.port;
	}
	...
	public ListeningPointImpl getListeningPoint() {
		if (listeningPoint == null) {
			if (logger.isLoggingEnabled()) {
				this.logger.logError("getListeningPoint" + this + " returning null listeningpoint");
	...
	public void setListeningPoint(ListeningPointImpl lp) {
		if (logger.isLoggingEnabled(LogWriter.TRACE_DEBUG)) {
			this.logger.logDebug("setListeningPoint" + this + " listeningPoint = " + lp);
