...
public class URIFieldParser extends SDPParser {
	...
	/**
	 * 
	 * public static void main(String[] args) throws ParseException { String uri[] = { "u=http://www.cs.ucl.ac.uk/staff/M.Handley/sdp.03.ps\n", "u=sip:j.doe@big.com\n", "u=sip:j.doe:secret@big.com;transport=tcp\n", "u=sip:j.doe@big.com?subject=project\n", "u=sip:+1-212-555-1212:1234@gateway.com;user=phone\n" };
	 * 
	 * for (int i = 0; i < uri.length; i++) { URIFieldParser uriFieldParser=new URIFieldParser( uri[i] ); URIField uriField=uriFieldParser.uriField(); System.out.println("toParse: " +uri[i]); System.out.println("encoded: " +uriField.encode()); }
	 * 
	 * }
	 **/
}
/*
 * $Log: not supported by cvs2svn $ Revision 1.4 2006/07/13 09:02:41 mranga Issue number: Obtained from: Submitted by: jeroen van bemmel Reviewed by: mranga Moved some changes from jain-sip-1.2 to java.net
 *
