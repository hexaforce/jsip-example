...
public class EmailFieldParser extends SDPParser {
	...
	/*
	 * public static void main(String[] args) throws ParseException { String email[] = { "e=mjh@isi.edu (Mark Handley)\n", "e=Mark Handley <mjh@isi.edu>\n", "e= <mjh@isi.edu>\n", "e=mjh@isi.edu\n" };
	 * 
	 * for (int i = 0; i < email.length; i++) { EmailFieldParser emailFieldParser=new EmailFieldParser( email[i] ); EmailField emailFields=emailFieldParser.emailField(); System.out.println("toParse: " +email[i]); System.out.println("encoded: " +emailFields.encode()); }
	 * 
	 * }
	 */
...
/*
 * $Log: not supported by cvs2svn $ Revision 1.5 2006/07/13 09:02:36 mranga Issue number: Obtained from: Submitted by: jeroen van bemmel Reviewed by: mranga Moved some changes from jain-sip-1.2 to java.net
 *
 ...
 *
 *
 * Revision 1.3 2004/12/13 15:01:39 mranga Issue number: 47 Submitted by: espen@dev.java.net Reviewed by: mranga
 *
