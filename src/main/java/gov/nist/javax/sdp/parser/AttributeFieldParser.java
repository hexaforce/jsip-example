...
public class AttributeFieldParser extends SDPParser {
	...
	/**
	 * public static void main(String[] args) throws ParseException { String attribute[] = { "a=rtpmap:0 PCMU/8000\n", "a=rtpmap:31 LPC\n", "a=rtpmap:0 PCMU/8000\n", "a=rtpmap:4 G723/8000\n", "a=rtpmap:18 G729A/8000\n", "a=ptime:30\n", "a=orient:landscape\n", "a=recvonly\n", "a=T38FaxVersion:0\n", "a=T38maxBitRate:14400\n", "a=T38FaxFillBitRemoval:0\n", "a=T38FaxTranscodingMMR:0\n", "a=T38FaxTranscodingJBIG:0\n", "a=T38FaxRateManagement:transferredTCF\n", "a=T38FaxMaxBuffer:72\n", "a=T38FaxMaxDatagram:316\n", "a=T38FaxUdpEC:t38UDPRedundancy\n" };
	 * 
	 * for (int i = 0; i < attribute.length; i++) { AttributeFieldParser attributeFieldParser = new AttributeFieldParser( attribute[i] ); AttributeField attributeField= attributeFieldParser.attributeField(); System.out.println("encoded: " + attributeField.encode()); }
	 * 
	 * }
	 **/
}
/*
 * $Log: not supported by cvs2svn $ Revision 1.5 2006/07/13 09:02:35 mranga Issue number: Obtained from: Submitted by: jeroen van bemmel Reviewed by: mranga Moved some changes from jain-sip-1.2 to java.net
 *
