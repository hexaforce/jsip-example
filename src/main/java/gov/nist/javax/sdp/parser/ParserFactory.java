...
public class ParserFactory {
	...
	private static final String packageName = PackageNames.SDP_PACKAGE + ".parser";
...
/*
 * $Log: not supported by cvs2svn $ Revision 1.5 2006/07/13 09:02:33 mranga Issue number: Obtained from: Submitted by: jeroen van bemmel Reviewed by: mranga Moved some changes from jain-sip-1.2 to java.net
 *
 ...
 *
 *
 * Revision 1.3 2005/04/04 09:29:02 dmuresan Replaced new String().getClass() with String.class.
 *
