...
/*
 * $Log: not supported by cvs2svn $ Revision 1.10 2009/07/17 18:57:17 emcho Converts indentation tabs to spaces so that we have a uniform indentation policy in the whole project.
 *
 * Revision 1.9 2008/01/18 02:18:24 mranga Issue number: Obtained from: Submitted by: Reviewed by: mranga Moved out some test code.
 *
 * Revision 1.8 2006/11/22 04:08:57 rborba Fixed a null pointer exception when an SDP is received with an empty session name ("s=").
 *
 * Revision 1.7 2006/07/13 09:02:37 mranga Issue number: Obtained from: Submitted by: jeroen van bemmel Reviewed by: mranga Moved some changes from jain-sip-1.2 to java.net
 *
 ...
 *
 *
 * Revision 1.5 2005/01/21 21:19:24 mranga Reviewed by: mranga Strip leading whitespace while parsing Sdp Announce messages.
 *
 * Revision 1.4 2004/02/18 14:33:02 mranga Submitted by: Bruno Konik Reviewed by: mranga Remove extraneous newline in encoding messages. Test for empty sdp announce rather than die with null when null is passed to sdp announce parser. Fixed bug in checking for \n\n when looking for message end.
 *
