...
public interface AddressResolver {
	 ...
	 * @return a new hop ( if the address is recomputed ) or the original hop if this is just an identity mapping ( the default behavior ).
	 */
