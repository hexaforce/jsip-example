...
public class FactoryTestHarness extends TestHarness {
	...
	protected static String hosts[] = { "herbivore.ncsl.nist.gov", "foo.bar.com", "129.6.55.181", "herbivore.ncsl.nist.gov:5070", "big.com", "big.com", "big.com", "gateway.com", "10.1.2.3", "example.com", "alice", "registrar.com", "10.10.30.186:666", "abc123.xyz-test." };

	static protected String urls[] = { "sip:herbivore.ncsl.nist.gov:5070;maddr=129.6.55.251;lr", "sip:1-301-975-3664@foo.bar.com;user=phone", "sip:129.6.55.181", "sip:herbivore.ncsl.nist.gov:5070;maddr=129.6.55.251;method=INVITE?contact=sip:foo.bar.com", "sip:j.doe@big.com", "sip:j.doe:secret@big.com;transport=tcp", "sip:j.doe@big.com?subject=project", "sip:j.doe@big.com?subject=", "sip:+1-212-555-1212:1234@gateway.com;user=phone", "sip:1212@gateway.com", "sip:alice@10.1.2.3", "sip:alice@example.com", "sip:alice", "sip:alice@registrar.com;method=REGISTER", "sip:annc@10.10.30.186:6666;early=no;play=http://10.10.30.186:8080/examples/pin.vxml", "http://10.10.30.186:8080/examples/pin.vxml", "sip:&=+$,;?/%00-_.!~*'()@abc123.xyz-test.:12345;weird123[]/:&+$=weird123[]/:&+$?[]/?:+$=[]/?:+$", "sip:[2001:db8::9:1];real=[2001:db8::9:255]\n", "sip:user;par=u%40example.net@example.com\n" };

	protected static String telUrls[] = { "tel:+463-1701-4291", "tel:46317014291;phone-context=+5", "tel:+1-212-555-1212" };

	protected static String phoneNumbers[] = { "+463-1701-4291", "46317014291;phone-context=+5", "+1-212-555-1212" };

	protected static String addresses[] = { "herbivore.ncsl.nist.gov", "1-301-975-3664@foo.bar.com", "129.6.55.181", "herbivore.ncsl.nist.gov:5070", "j.doe@big.com", "secret@big.com", "j.doe@big.com", "1212@gateway.com", "alice@10.1.2.3", "alice@example.com", "alice", "alice@registrar.com", "annc@10.10.30.186:666" // 666 is the sign of the beast. heh. heh.
	};
	protected static String msgString = "INVITE sip:littleguy@there.com:5060 SIP/2.0\r\n" + "Via: SIP/2.0/UDP 65.243.118.100:5050\r\n" + "From: Me  <sip:M.Ranganathan@sipbakeoff.com>;tag=1234\r\n" + "To: \"littleguy@there.com\" <sip:littleguy@there.com:5060> \r\n" + "Call-ID: Q2AboBsaGn9!?x6@sipbakeoff.com \r\n" + "CSeq: 1 INVITE \r\n"
	...
	protected static String multiHeaders[] = { "Allow: INVITE , FooBar\r\n", "Accept-Encoding: compress;q=0.5,gzip;q=1.0\r\n", "Accept: application/sdp;level=1,application/x-private,text/html\r\n", "Contact: Bo Bob Biggs "
			// BUG submitted by Ben Evans (opencloud): SIP syntax does not
			// permit space between < and URI
			+ "<sip:user@example.com?Route=%3Csip:sip.example.com%3E>," + "Joe Bob Briggs <sip:mranga@nist.gov>\r\n", "Proxy-Require: foo, 1234 \r\n", "Record-Route: <sip:bob@biloxi.com>," + "<sip:bob@biloxi.com;maddr=10.1.1.1>," + "<sip:+1-650-555-2222@iftgw.there.com;" + "maddr=ss1.wcom.com>\r\n",
	...
	protected static String headers[] = { "Accept: application/sdp;level=1\n", "Accept: application/x-private\n", "Accept: text/html\n", "Accept: text/*\n", "Accept: text/*strange_extension*\n", "Accept: application/sdp;level=1;q=1.0\n", "Accept-Encoding: compress\n", "Accept-Encoding: gzip\n", "Accept-Encoding:\n", "Accept-Encoding: *\n", "Accept-Encoding: *special*\n", "Accept-Encoding: compress;q=0.5\n", "Accept-Encoding: gzip;q=1.0\n", "Accept-Encoding: identity; q=0.5\n", "Accept-Language: da\n", "Accept-Language:\n", "Accept-Language: en-gb;q=0.8\n", "Accept-Language: *\n",
			...
			"FROM: \"A. G. Bell\" <sip:agb@bell-telephone.com> ;tag=a48s\n", "In-Reply-To: 70710@saturn.bell-tel.com\n", "In-Reply-To: 70710 \n", "Max-Forwards: 34\n", "Max-Forwards: 10 \n", "MIME-Version: 1.0 \n", "Min-Expires: 60 \n", "Organization: Boxes by Bob\n", "Priority: emergency\n", "Proxy-Authenticate: Digest realm=\"MCI WorldCom SIP\"," + "domain=\"sip:ss2.wcom.com\", " + "nonce=\"ea9c8e88df84f1cec4341ae6cbe5a359\"," + "opaque=\"\", stale=FALSE, algorithm=MD5\n", "Proxy-Authorization: Digest realm=\"MCI WorldCom SIP\"," + "domain=\"sip:ss2.wcom.com\", " + "nonce=\"ea9c8e88df84f1cec4341ae6cbe5a359\"," + "opaque=\"\", stale=FALSE, algorithm=MD5\n", "Proxy-Require: foo \n", "Proxy-Require: 1234 \n", "RAck: 776656 1 INVITE\n", "Reason: SIP ;cause=200 ;text=\"Call completed elsewhere\"\n", "Reason: Q.850 ;cause=16 ;text=\"Terminated\"\n", "Reason: SIP ;cause=600 ;text=\"Busy Everywhere\"\n",
	...
	protected Header createRiHeaderFromString(String hdr) {
		try {
			...
			Header riHeader = riHeaderFactory.createHeader(name.toString().trim(), body.toString().trim());
			return riHeader;
