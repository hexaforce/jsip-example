...
public abstract class ScenarioHarness extends TestHarness {
	...
	public void setUp() throws Exception {
		if (testedImplFlag) {
			this.tiProtocolObjects.add(new ProtocolObjects("ti" + super.getName(), "gov.nist", transport, true, false, false));

			this.addRiProtocolObjects(new ProtocolObjects("ri" + super.getName(), super.getImplementationPath(), transport, true, false, false));
			/*
			 * if (!getImplementationPath().equals("gov.nist")) this.riProtocolObjects = new ProtocolObjects( super.getName(), super.getImplementationPath(), transport, true); else this.riProtocolObjects = tiProtocolObjects;
			 */

		} else {
			this.tiProtocolObjects.add(new ProtocolObjects("ti" + super.getName(), getImplementationPath(), transport, true, false, false));
			this.addRiProtocolObjects(new ProtocolObjects("ri" + super.getName(), "gov.nist", transport, true, false, false));
	...
	public void setUp(int nri, int nti) throws Exception {
		if (testedImplFlag) {
			for (int i = 0; i < nti; i++) {
				this.tiProtocolObjects.add(new ProtocolObjects("ti" + super.getName() + i, "gov.nist", transport, true, false, false));
			}
			for (int i = 0; i < nri; i++) {

				this.addRiProtocolObjects(new ProtocolObjects("ri" + super.getName() + i, super.getImplementationPath(), transport, true, false, false));
			}
			/*
			 * if (!getImplementationPath().equals("gov.nist")) this.riProtocolObjects = new ProtocolObjects( super.getName(), super.getImplementationPath(), transport, true); else this.riProtocolObjects = tiProtocolObjects;
			 */
			...
			for (int i = 0; i < nti; i++) {
				this.tiProtocolObjects.add(new ProtocolObjects("ti" + super.getName() + i, getImplementationPath(), transport, true, false, false));
			}
			for (int i = 0; i < nri; i++) {
				this.addRiProtocolObjects(new ProtocolObjects("ri" + super.getName() + i, "gov.nist", transport, true, false, false));
			}
	...
	public void setUp(boolean riAutoDialog) throws Exception {
		if (testedImplFlag) {
			...
			this.addRiProtocolObjects(new ProtocolObjects("ri" + super.getName(), super.getImplementationPath(), transport, riAutoDialog, false, false));
			/*
			 * if (!getImplementationPath().equals("gov.nist")) this.riProtocolObjects = new ProtocolObjects( super.getName(), super.getImplementationPath(), transport, true); else this.riProtocolObjects = tiProtocolObjects;
			 */
			...
			this.tiProtocolObjects.add(new ProtocolObjects("ti" + super.getName(), getImplementationPath(), transport, true, false, false));
			this.addRiProtocolObjects(new ProtocolObjects("ri" + super.getName(), "gov.nist", transport, riAutoDialog, false, false));
	 ...
	 */
	protected void addTiProtocolObjects(test.tck.msgflow.callflows.ProtocolObjects tiProtocolObjects) {
