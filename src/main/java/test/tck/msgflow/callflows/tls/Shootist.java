...
public class Shootist implements SipListener {
	...
	public void processInvite(Request request, ServerTransaction st) {
		try {
			...
			Address address = protocolObjects.addressFactory.createAddress("Shootme <sips:" + myAddress + ":" + myPort + ">");
	...
	public void sendInvite() {
		...
		try {
			...
			Address address = protocolObjects.addressFactory.createAddress("<sips:" + PEER_ADDRESS + ":" + PEER_PORT + ">");
