...
public class Shootist implements SipListenerExt {
	...
	public SipProvider createSipProvider() {
		try {
			...
			logger.error(ex);
			TxTimeoutTest.fail("Shootist: unable to create provider");
			return null;
		}
	}
	...
	public void processRequest(RequestEvent requestReceivedEvent) {
		...
		TxTimeoutTest.fail("Shouldnt receive any request:\n" + request);
	...
	public void processResponse(ResponseEvent responseReceivedEvent) {
		...
		try {
			...
			TxTimeoutTest.fail("Shootist: Exception on process respons/send info", ex);
		}
	...
	public void processDialogTimeout(DialogTimeoutEvent timeoutEvent) {
		...
		if (timeoutDialog == null) {
			TxTimeoutTest.fail("Shootist: Exception on timeout, dialog shouldn't be null");
		}
		...
		if (dialogTimeoutEvent.getReason() == Reason.EarlyStateTimeout && statusCode > 0 && statusCode < 200) {
			stateIsOk = true;
		}
	}
	...
	void sendRequest(String method) {
		...
		try {
			...
			TxTimeoutTest.fail("Shootist: Failed to send invite: ", ex);
