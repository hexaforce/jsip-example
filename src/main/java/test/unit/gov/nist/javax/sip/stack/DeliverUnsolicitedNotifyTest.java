...
public class DeliverUnsolicitedNotifyTest extends TestCase implements SipListener {
	...
	public void processRequest(RequestEvent requestEvent) {
		try {
			...
			Response response = this.messageFactory.createResponse(Response.OK, requestEvent.getRequest());
	...
	public void testSendRequest() {
		try {
			...
			Request request = messageFactory.createRequest(requestURI, Request.NOTIFY, callIdHeader, cSeqHeader, fromHeader, toHeader, viaHeaders, maxForwards);
			...
			RouteHeader route = headerFactory.createRouteHeader(addressFactory.createAddress("<sip:127.0.0.1:" + port + ";transport=" + transport + ";lr>"));
			...
			SubscriptionStateHeader ssh = headerFactory.createSubscriptionStateHeader(SubscriptionStateHeader.ACTIVE);
