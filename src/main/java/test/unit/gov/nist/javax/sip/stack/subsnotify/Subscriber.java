...
public class Subscriber implements SipListener {
	...
	public static Subscriber createSubcriber() throws Exception {
		...
		properties.setProperty("gov.nist.javax.sip.DEBUG_LOG", "logs/subscriberdebug.txt");
		properties.setProperty("gov.nist.javax.sip.SERVER_LOG", "logs/subscriberlog.txt");
