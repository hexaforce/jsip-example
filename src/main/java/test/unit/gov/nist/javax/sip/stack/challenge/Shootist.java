...
public class Shootist implements SipListener {
	...
	public void processResponse(ResponseEvent responseReceivedEvent) {
		...
		try {
			...
			if (response.getStatusCode() == Response.UNAUTHORIZED && ((CSeqHeader) response.getHeader(CSeqHeader.NAME)).getMethod().equals(Request.INVITE)) {
				...
				CSeqHeader cseq = (CSeqHeader) origInvite.getHeader(CSeqHeader.NAME);
				cseq.setSeqNumber(cseq.getSeqNumber() + 1);

				// clear Via branch
				ViaHeader via = (ViaHeader) origInvite.getHeader(ViaHeader.NAME);
			...
			} else if (response.getStatusCode() == Response.OK && ((CSeqHeader) response.getHeader(CSeqHeader.NAME)).getMethod().equals(Request.INVITE)) {
	 ...
	 * (non-Javadoc)
	 *
	 * @seejavax.sip.SipListener#processTransactionTerminated(javax.sip. TransactionTerminatedEvent)
	 */
