...
public class SecurityVerifyParserTest extends ParserTestCase {
	public void testParser() {
		...
		String[] securityVerify = { "Security-Verify: ipsec-3gpp; alg=hmac-sha-1-96; spi-c=23456789; spi-s=12345678; " + "port-c=2468; port-s=1357; q=0.1\n",

				// list
				"Security-Verify: ipsec-3gpp; alg=hmac-sha-1-96; spi-c=23456789; spi-s=12345678; " + "port-c=2468; port-s=1357; q=0.1, " +
