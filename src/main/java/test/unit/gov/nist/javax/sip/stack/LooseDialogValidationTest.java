...
/**
 * Test originally tested the LOOSE_DIALOG_VALIDATION stack proprty to accept ACK retransmissions and to not validate CSeq numbers. Later 4th Novemenr 2009 it was decided that instead of turing on LOOSE_DIALOG_VALIDATION, these features will be active when AUTOMATIC_DIALOG_SUPPORT is "off".
 * 
 * @author vralev
 *
 */
		...
		public void processResponse(ResponseEvent responseEvent) {
			...
			if (num < 5) {
				try {
					...
					cseq.setSeqNumber(1);
					ClientTransaction ct = provider.getNewClientTransaction(messageRequest);
