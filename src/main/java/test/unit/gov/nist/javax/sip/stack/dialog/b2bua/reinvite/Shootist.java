...
public class Shootist implements SipListener {
	...
	public void sendInvite() {
		try {
			...
			CSeqHeader cSeqHeader = headerFactory.createCSeqHeader(4321L, Request.INVITE);
	...
	public void processDialogTerminated(DialogTerminatedEvent dialogTerminatedEvent) {
		TestCase.assertTrue("DTE dialog must be one of those we canceled", this.canceledDialog.contains((Dialog) dialogTerminatedEvent.getDialog()));
