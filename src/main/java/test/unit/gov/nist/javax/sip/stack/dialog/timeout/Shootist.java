...
public class Shootist implements SipListenerExt {
	...
	public SipProvider createSipProvider() {
		try {
			...
			logger.error(ex);
			DialogTimeoutTest.fail("Shootist: unable to create provider");
			return null;
		}
	}
	...
	public void processResponse(ResponseEvent responseReceivedEvent) {
		...
		try {
			...
			DialogTimeoutTest.fail("Shootist: Exception on process respons/send info", ex);
		}
	...
	public void processTimeout(javax.sip.TimeoutEvent timeoutEvent) {
		if (protocolObjects.autoDialog) {
			DialogTimeoutTest.fail("Shootist: Exception on timeout, event shouldn't be thrown on automatic dailog creation by the stack");
		}
	}
	...
	public void processDialogTimeout(DialogTimeoutEvent timeoutEvent) {
		...
		if (timeoutDialog == null) {
			DialogTimeoutTest.fail("Shootist: Exception on timeout, dialog shouldn't be null");
		}
	...
	void sendInviteRequest() {
		...
		try {
			...
			DialogTimeoutTest.fail("Shootist: Failed to send invite: ", ex);
