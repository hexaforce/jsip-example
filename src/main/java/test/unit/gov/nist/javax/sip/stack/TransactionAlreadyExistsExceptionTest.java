...
public class TransactionAlreadyExistsExceptionTest extends TestCase {
	...
	public class Shootist implements SipListener {
		...
		public void init() {
			...
			try {
				...
				try {
					request = messageFactory.createRequest(retransmittedRequest);
	...
	public void testSendInviteWithBadHeader() {
		...
		assertTrue("Should see alreadyExistsException or only one INVITE seen", shootme.sawTransactionExistsException || shootme.sawInvite == 1);
