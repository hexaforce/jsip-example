...
public class SipObjects {
	...
	public SipObjects(int myPort, String stackName, String automaticDialog) {
		...
		/*
		 * properties.setProperty("gov.nist.javax.sip.LOG_FACTORY", SipFoundryLogRecordFactory.class .getName());
		 */
		...
		try {
			...
			/*
			 * SipFoundryAppender sfa = new SipFoundryAppender(new SipFoundryLayout(), logFileDirectory + "sip" + stackname + ".log");
			 * 
