 ...
 * and http://java.net/jira/browse/JSIP-362
 * 
 * Shootist sends Invite to Shootme, Shootme before responding close all TCP Sockets simulating a disconnect.
 * Shootme should be able to send the responses back to the shootist and get the ACK
 */
    ...
    static {
     ...
     class Shootme  implements SipListener {
            ...
            public class DelayedInviteResponsesTask extends TimerTask {
            	...
            	public DelayedInviteResponsesTask(RequestEvent requestEvent,
    					SipProvider sipProvider) {
