...
//        }
    ...
    public void processTimeout(javax.sip.TimeoutEvent timeoutEvent) {
    	...
    	if(protocolObjects.autoDialog) {
    		DialogTimeoutTest.fail(
            	"Shootme: Exception on timeout, event shouldn't be thrown on automatic dailog creation by the stack");
    		stateIsOk = false;
    	}    	    	
        /*
    ...
    public void processTimeout(DialogTimeoutEvent timeoutEvent) {
    	DialogTimeoutTest.fail(
    		"Shootme: Exception on timeout, event shouldn't be thrown since the listener is not implemented");
	}
