...
public class ShootmeNotImplementingListener implements SipListener {
...
//        {
//            DialogTimeoutTest.fail("Shootme: Got DialogTerinatedEvent, this shouldnt happen");
//            stateIsOk=false;
//        }
	...
	public void processTimeout(javax.sip.TimeoutEvent timeoutEvent) {
		...
		if (protocolObjects.autoDialog) {
			DialogTimeoutTest.fail("Shootme: Exception on timeout, event shouldn't be thrown on automatic dailog creation by the stack");
			stateIsOk = false;
		}
		/*
		 * System.out.println("state = " + transaction.getState()); System.out.println("dialog = " + transaction.getDialog()); System.out.println("dialogState = " + transaction.getDialog().getState()); System.out.println("Transaction Time out" + transaction.getBranchId());
		 */

	}

	public void processTimeout(DialogTimeoutEvent timeoutEvent) {
		DialogTimeoutTest.fail("Shootme: Exception on timeout, event shouldn't be thrown since the listener is not implemented");
	}
	...
	/**
	 * @param stateIsOk the stateIsOk to set
	 */
	public void setStateIsOk(boolean stateIsOk) {
		this.stateIsOk = stateIsOk;
	}

	/**
	 * @return the stateIsOk
	 */
	public boolean isStateIsOk() {
		return stateIsOk;
	}
