...
public class SelfroutingTest extends ScenarioHarness {
	...
	class Shootist implements SipListener {
		...
		public void processInvite(Request request, ServerTransaction serverTransactionId) {
			try {
				Response response = protocolObjects.messageFactory.createResponse(200, request);
		...
		public void sendInvite() {
			...
			try {
				...
				SipURI requestURI = protocolObjects.addressFactory.createSipURI(toUser, myAddress + ":" + myPort);
				...
				Address address = protocolObjects.addressFactory.createAddress("<sip:" + myAddress + ":" + myPort + ">");
