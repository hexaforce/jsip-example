...
public class Shootist implements SipListener {
	...
	public void processResponse(ResponseEvent responseReceivedEvent) {
		...
		logger.info("Response received with client transaction id " + tid + " rc = " + response.getStatusCode());
		if (tid == null) {
	...
	public void sendInvite() {
		...
		try {
			...
			CSeqHeader cSeqHeader = protocolObjects.headerFactory.createCSeqHeader(1718L, Request.INVITE);
