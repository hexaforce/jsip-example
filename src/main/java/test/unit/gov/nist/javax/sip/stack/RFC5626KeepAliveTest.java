...
/**
 * Test for RFC 5626 Section 4.4.1 tests the various conditions outlined in the flow available at https://docs.google.com/drawings/d/1vWHQU4Xqy_gkbsprJ8gumoBi2ajdFw71uw_5vrn2V8g/edit?hl=en_US
 * 
...
public class RFC5626KeepAliveTest extends ScenarioHarness implements SipListenerExt {
	...
	class Shootme implements SipListenerExt {
		...
		public void processIOException(IOExceptionEvent exceptionEvent) {
			logger.info("Shootme An IO Exception was detected : " + exceptionEvent.getHost());
...
//	                    fail();
		...
		public void sendInvite() {
			...
			try {
				...
				SipURI requestURI = protocolObjects.addressFactory.createSipURI(toUser, Shootme.myAddress + ":" + Shootme.myPort);
