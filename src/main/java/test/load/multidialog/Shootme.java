...
public class Shootme implements SipListener {
	...
	class TTask extends TimerTask {
		...
		public void run() {
			...
			try {
				...
				/*
				 * if (dialog != null) { System.out.println("Dialog " + dialog); System.out.println("Dialog state " + dialog.getState()); }
				 */
	...
	public void processAck(RequestEvent requestEvent, ServerTransaction serverTransaction) {
		...
		try {
			...
			this.createdCount++;
			System.out.println("Dialog Created = " + dialog.getDialogId() + " createdCount " + this.createdCount + " Dialog State = " + dialog.getState());
	...
	public void processInvite(RequestEvent requestEvent, ServerTransaction serverTransaction) {
		try {
			...
			if (transactionIDs.containsKey(st.getBranchId())) {
				System.out.println("OOOPS -- seen this guy before!! This must be a late guy " + st.getBranchId() + " st = " + transactionIDs.get(st.getBranchId()));
				return;
			} else {
