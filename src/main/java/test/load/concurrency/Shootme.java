...
public class Shootme extends TestCase implements SipListener {
	...
	public void processInvite(RequestEvent requestEvent, ServerTransaction serverTransaction) {
		...
		try {
			...
			Address address = addressFactory.createAddress("Shootme <sip:127.0.0.1:5070;transport=" + transport + ">");
	...
	public void processDialogTerminated(DialogTerminatedEvent dialogTerminatedEvent) {
		...
		if (terminationCount % 100 == 0)
			System.out.println("DialogTermination count = " + this.terminationCount);
	}
