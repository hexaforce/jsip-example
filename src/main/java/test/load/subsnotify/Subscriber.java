...
public class Subscriber implements SipListener {
	...
	protected static final String usageString = "java " + "examples.subscriber.Shootist \n" + ">>>> is your class path set to the root?";
	...
	public void CreateSubscribeRequest() {
		...
		try {
			...
			FromHeader fromHeader = headerFactory.createFromHeader(fromNameAddress, Long.valueOf(new Random().nextLong()).toString());
			...
			ExpiresHeader expires_header = headerFactory.createExpiresHeader(200);
