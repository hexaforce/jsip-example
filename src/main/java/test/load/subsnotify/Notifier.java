...
public class Notifier implements SipListener {
	...
	public void processRequest(RequestEvent requestEvent) {
		...
		if (request.getMethod().equals(Request.SUBSCRIBE)) {
			ServerTransaction st = processSubscribe(requestEvent, serverTransactionId);
	...
	public void sendNotify(Dialog dialog) {
		...
		try {
			...
			request.setHeader(headerFactory.createContactHeader(contactAddress));
	...
	public ServerTransaction processSubscribe(RequestEvent requestEvent, ServerTransaction serverTransactionId) {
		...
		try {
			...
			if (toHeader.getTag() == null) {
				String tag = Long.valueOf(new java.util.Random().nextLong()).toString();
				toHeader.setTag(tag);
			}
