...
public class LogRecordImpl implements LogRecord {
	 ...
	 * @param timeStamp    -- the reception time
	 * @param isSender     -- the flag indicates whether we are sending or recieving the record
	 * @param firstLine    -- the messge first line
	 * @param tid          -- the transaction id
	 * @param callId       -- the callId
	 * @param timestampVal -- the timestamp Header value.
	 */
