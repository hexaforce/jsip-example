...
/**
 * This example demonstrates how an application can monitor the health of the internal threads of the SIP Stack.
 *
...
public class ThreadAudit {
	...
	public static void init(boolean enableThreadAudit, long auditInterval) {
		...
		if (enableThreadAudit) {
			...
			properties.setProperty("gov.nist.javax.sip.THREAD_AUDIT_INTERVAL_IN_MILLISECS", String.valueOf(auditInterval));
		}
