...
public class Subscriber implements SipListener {
	...
	public void processNotify(Request request, ServerTransaction serverTransactionId) {
		try {
			...
			SubscriptionStateHeader subscriptionState = (SubscriptionStateHeader) request.getHeader(SubscriptionStateHeader.NAME);
	...
	public void init() {
		...
		properties.setProperty("javax.sip.OUTBOUND_PROXY", "127.0.0.1:5070/" + transport);
