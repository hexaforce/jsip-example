...
public class Referee implements SipListener {
	...
	private static void initFactories() throws Exception {
		...
		logger.addAppender(new FileAppender(new SimpleLayout(), "refereeoutputlog.txt"));
		...
		properties.setProperty("gov.nist.javax.sip.DEBUG_LOG", "refereedebug.txt");
		properties.setProperty("gov.nist.javax.sip.SERVER_LOG", "refereelog.txt");
