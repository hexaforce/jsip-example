 ...
 *
 * referer sends REFER to referee, with Refer-To set to Shootme referee sends INVITE to Shootme, and NOTIFYs to referer about call progress
 *
...
public class Referer implements SipListener {
	...
	static {
		try {
			...
			logger.addAppender(new FileAppender(new SimpleLayout(), "refereroutputlog.txt"));
		} catch (Exception ex) {
	...
	protected static final String usageString = "java " + "examples.subsnotify.Subscriber \n" + ">>>> is your class path set to the root?";
	...
	public void createProvider() throws Exception {
		...
		this.listeningPoint = sipStack.createListeningPoint("127.0.0.1", 5060, transport);
	...
	public void sendSubscribe() {
		...
		try {
			...
			// Create the request.
			Request request = messageFactory.createRequest(requestURI, Request.REFER, callIdHeader, cSeqHeader, fromHeader, toHeader, viaHeaders, maxForwards);
			...
			ReferToHeader referTo = headerFactory.createReferToHeader(addressFactory.createAddress("<sip:127.0.0.1:" + 5070 + ">"));
	...
	public static void main(String args[]) throws Exception {
		...
		properties.setProperty("gov.nist.javax.sip.DEBUG_LOG", "refererdebug.txt");
		properties.setProperty("gov.nist.javax.sip.SERVER_LOG", "refererlog.txt");
