...
/**
 * This class is a UAS template for anroid JSIP stack
 *
...
public class Shootme implements SipListener {
	...
	public void init() {
		...
		properties.setProperty("android.gov.nist.javax.sip.DEBUG_LOG", "shootmedebug.txt");
		properties.setProperty("android.gov.nist.javax.sip.SERVER_LOG", "shootmelog.txt");
