...
public class Shootist implements SipListener {
	...
	public void processBye(SipProvider sipProvider, Request request, ServerTransaction serverTransactionId) {
		try {
	...
	public void init() {
		...
		try {
			...
			ViaHeader viaHeader = headerFactory.createViaHeader(myAddress, sipProvider.getListeningPoint("udp").getPort(), transport, null);
