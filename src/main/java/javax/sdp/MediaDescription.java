 ...
 *
 * a mediaType (e.g., audio, video, etc.) a port number (or set of ports) a protocol to be used (e.g., RTP/AVP) a set of media formats which correspond to Attributes associated with the media description.
 *
