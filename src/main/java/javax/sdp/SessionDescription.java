 ...
 *
 * The SessionDescription also holds timing information for the session (e.g. start, end, repeat, time zone) and bandwidth supported for the session.
 *
...
public interface SessionDescription extends Serializable, Cloneable {
	 ...
	 * @param create boolean to set
	 * @throws SdpException
	 * @return a Hashtable containing the zone adjustments, where the key is the Adjusted Time Zone and the value is the offset.
	 */
	 ...
	 * 
	 * @param zoneAdjustments zoneAdjustments - a Hashtable containing the zone adjustments, where the key is the Adjusted Time Zone and the value is the offset.
	 * @throws SdpException if the vector is null
	 */
	 ...
	 * 
	 * @param create create - specifies whether to return null or a new empty Vector in case no attributes exists for this Description
