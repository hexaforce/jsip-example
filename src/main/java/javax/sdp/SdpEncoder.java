...
public interface SdpEncoder {
	 ...
	 * 
	 * @param enc enc - name of character encoding to use for session name and information data
	 * @throws UnsupportedEncodingException if the named encoding is not supported
	 */
	public void setEncoding(String enc) throws UnsupportedEncodingException;

	/**
	 * Specifies whether to try to write "typed-time" fields instead of raw integer values. This makes the session description more readable but may have an adverse effect on serialization time.
	 *
	 * Ordinarily time values are given in numbers of seconds, but for readability they may be specified using logical units. From RFC 2327:
	 *
	 ...
	 *
	 * @param flag if true this Outputter should emit "typed" time specs in preference to untyped times.
	 */
