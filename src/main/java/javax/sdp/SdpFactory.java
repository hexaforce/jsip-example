...
public class SdpFactory extends Object {
	...
	public SessionDescription createSessionDescription() throws SdpException {
		...
		try {
			originImpl = (OriginField) this.createOrigin("user", InetAddress.getLocalHost().getHostAddress());
	 ...
	 * @param numPorts          number of ports used for this media stream
	 * @param transport         transport type, eg "RTP/AVP"
	 * @param staticRtpAvpTypes list of static RTP/AVP media payload types which should be specified by the returned MediaDescription throws IllegalArgumentException if passed an invalid RTP/AVP payload type
	 ...
	 *
	 * @param t the Time that the time description applies to. Returns TimeDescription object with the specified properties.
	 * @throws SdpException
	...
	/**
	 * Returns a Connection object with the specified address. This is equivalent to
	 *
	 ...
	 * @param offsets        the list of offsets relative to the start time of the Time object with which the returned RepeatTime will be associated
	 * @return RepeatTime
	 */
	 ...
	 *
	 * @param args
	 * @throws SdpException public static void main(String[] args) throws SdpException { }
	 */
