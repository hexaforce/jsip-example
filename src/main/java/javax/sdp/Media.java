...
/**
 * A Media represents an m= field contained within a MediaDescription. The Media identifies information about the format(s) of the media associated with the MediaDescription.
 *
