 ...
 * <p>
 * This specification defines a single Response event object to handle all Response messages. The Response event encapsulates the Response message that can be retrieved from {@link javax.sip.ResponseEvent#getResponse()}. Therefore the event type of a Response event can be determined as follows:
 * <p>
 ...
 * <ul>
 * <li>source - the source of the event i.e. the SipProvider sending the ResponseEvent.
 * <li>clientTransaction - the client transaction this ResponseEvent is associated with.
 * <li>Response - the Response message received on the SipProvider that needs passed to the application encapsulated in a ResponseEvent.
 * </ul>
 *
