...
public interface ExtensionHeader extends Header {
	 ...
	 * @throws ParseException which signals that an error has been reached unexpectedly while parsing the value parameter.
	 */
