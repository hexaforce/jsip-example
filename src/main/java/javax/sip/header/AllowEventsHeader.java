...
/**
 * This interface represents the AllowEvents SIP header, as defined by <a href = "http://www.ietf.org/rfc/rfc3265.txt">RFC3265</a>, this header is not part of RFC3261.
 * <p>
...
public interface AllowEventsHeader extends Header {
	 ...
	 * @throws ParseException which signals that an error has been reached unexpectedly while parsing the Strings defining the eventType supported
	 */
