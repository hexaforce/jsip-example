 ...
 * <p>
 * <b>Branch Parameter:<br>
 * </b> The branch parameter value MUST be unique across space and time for all requests sent by the User Agent. The exceptions to this rule are CANCEL and ACK for non-2xx responses. A CANCEL request will have the same value of the branch parameter as the request it cancels. An ACK for a non-2xx response will also have the same branch ID as the INVITE whose response it acknowledges.
 * <p>
...
public interface ViaHeader extends Parameters, Header {
	...
	/**
	 * Set the host part of this ViaHeader to the newly supplied <code>host</code> parameter.
	 *
	 ...
	 * @throws ParseException which signals that an error has been reached unexpectedly while parsing the protocol value.
	 */
	 ...
	 * @throws InvalidArgumentException if supplied value is less than zero or greater than 255, excluding -1 the default not set value.
	 */
	...
	/**
	 * Sets the value of the <code>maddr</code> parameter of this ViaHeader. The maddr parameter indicates the server address to be contacted for this user, overriding any address derived from the host field.
	 *
	 ...
	 * @throws ParseException which signals that an error has been reached unexpectedly while parsing the received value.
	 */
	 ...
	 * @return <code>true</code> if <code>obj</code> is an instance of this class representing the same ViaHeader as this, <code>false</code> otherwise.
	 * @since v1.2
	 */
