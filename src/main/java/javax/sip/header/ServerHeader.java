...
public interface ServerHeader extends Header {
	 ...
	 *
	 * @return a ListIterator over the List of strings identifying the software of this ServerHeader
	 */
	 ...
	 * @throws ParseException which signals that an error has been reached unexpectedly while parsing the List of product value strings.
	 */
