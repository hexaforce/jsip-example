...
public interface AuthorizationHeader extends Parameters, Header {
	...
	/**
	 * Sets the Realm of the AuthorizationHeader to the <var>realm</var> parameter value. Realm strings MUST be globally unique. It is RECOMMENDED that a realm string contain a hostname or domain name. Realm strings SHOULD present a human-readable identifier that can be rendered to a user.
	 *
	 * @param realm the new Realm String of this AuthorizationHeader.
	 * @throws ParseException which signals that an error has been reached unexpectedly while parsing the realm.
	 */
	...
	/**
	 * Sets the Username of the AuthorizationHeader to the <var>username</var> parameter value.
	 *
	 * @param username the new Username String of this AuthorizationHeader.
	 * @throws ParseException which signals that an error has been reached unexpectedly while parsing the username.
	 */
	...
	/**
	 * Sets the Nonce of the AuthorizationHeader to the <var>nonce</var> parameter value.
	 *
	 * @param nonce - the new nonce String of this AuthorizationHeader.
	 * @throws ParseException which signals that an error has been reached unexpectedly while parsing the nonce value.
	 */
	...
	/**
	 * Sets the URI of the AuthorizationHeader to the <var>uri</var> parameter value.
	 *
	 ...
	 *
	 * @note The syntax allows also non-URI strings, though it is not commonly used with SIP. To avoid parsing the string and treat it as opaque, applications should use getParameter("uri") instead of this method
	 */
	public URI getURI();

	/**
	 * Sets the Response of the AuthorizationHeader to the new <var>response</var> parameter value.
	 *
	 * @param response - the new response String of this AuthorizationHeader.
	 * @throws ParseException which signals that an error has been reached unexpectedly while parsing the Response.
	 */
	...
	/**
	 * Sets the Algorithm of the AuthorizationHeader to the new <var>algorithm</var> parameter value.
	 *
	 * @param algorithm - the new algorithm String of this AuthorizationHeader.
	 * @throws ParseException which signals that an error has been reached unexpectedly while parsing the algorithm value.
	 */
	...
	/**
	 * Sets the CNonce of the AuthorizationHeader to the <var>cNonce</var> parameter value.
	 *
	 * @param cNonce - the new cNonce String of this AuthorizationHeader.
	 * @throws ParseException which signals that an error has been reached unexpectedly while parsing the cNonce value.
	 */
	...
	/**
	 * Sets the Opaque value of the AuthorizationHeader to the new <var>opaque</var> parameter value.
	 *
	 * @param opaque - the new Opaque string of this AuthorizationHeader.
	 * @throws ParseException which signals that an error has been reached unexpectedly while parsing the opaque value.
	 */
	...
	/**
	 * Sets the MessageQop value of the AuthorizationHeader to the new <var>qop</var> parameter value.
	 *
	 * @param qop - the new Qop string of this AuthorizationHeader.
	 * @throws ParseException which signals that an error has been reached unexpectedly while parsing the Qop value.
	 */
	...
	/**
	 * Sets the Nonce Count of the AuthorizationHeader to the <var>nonceCount</var> parameter value.
	 *
	 * @param nonceCount - the new nonceCount integer of this AuthorizationHeader.
	 * @throws ParseException which signals that an error has been reached unexpectedly while parsing the nonceCount value.
	 */
