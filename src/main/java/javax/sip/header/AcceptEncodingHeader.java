 ...
 * <p>
 * An empty Accept-Encoding header field is permissible, it is equivalent to <code>Accept-Encoding: identity</code>, meaning no encoding is permissible.
 * <p>
...
public interface AcceptEncodingHeader extends Parameters, Encoding, Header {
	...
	/**
	 * Gets q-value of the encoding in this encoding value. A value of <code>-1</code> indicates the<code>q-value</code> is not set.
	 *
	 ...
	 * @throws InvalidArgumentException if the q parameter value is not <code>-1</code> or between <code>0 and 1</code>.
	 */
