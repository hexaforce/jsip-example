...
/**
 * 
 * The Call-ID header field uniquely identifies a particular invitation or all registrations of a particular client. A single multimedia conference can give rise to
 * 
 ...
 * 
 * between two users and is referred to as a dialog. It MUST be the same for all requests and responses sent by either User Agent in a dialog. It SHOULD be the same in each registration from a User Agent.
 * 
 * <p>
 * 
...
public interface CallIdHeader extends Header {
	...
	/**
	 * Compare this CallIdHeader for equality with another. This method overrides the equals method in javax.sip.Header. This method specifies object equality as outlined by <a href = "http://www.ietf.org/rfc/rfc3261.txt">RFC3261</a>. Call-IDs are case-sensitive and are simply compared byte-by-byte.
	 *
	 * @param obj the object to compare this CallIdHeader with.
	 * @return <code>true</code> if <code>obj</code> is an instance of this class representing the same CallIdHeader as this, <code>false</code> otherwise.
	 * @since v1.2
	 */
