...
public interface MaxForwardsHeader extends Header {
	...
	/**
	 * Compare this MaxForwardsHeader for equality with another. This method overrides the equals method in javax.sip.Header. This method specifies object equality as outlined by <a href = "http://www.ietf.org/rfc/rfc3261.txt">RFC3261</a>. Two MaxForwards header fields are equivalent if their max forwards integer match.
	 *
	 * @param obj the object to compare this MaxForwardsHeader with.
	 * @return <code>true</code> if <code>obj</code> is an instance of this class representing the same MaxForwardsHeader as this, <code>false</code> otherwise.
	 * @since v1.2
	 */
