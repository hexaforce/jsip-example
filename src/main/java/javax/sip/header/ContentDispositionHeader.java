 ...
 * <ul>
 * <li>session - indicates that the body part describes a session, for either calls or early (pre-call) media.
 * <li>render - indicates that the body part should be displayed or otherwise rendered to the user.
 * <li>icon - indicates that the body part contains an image suitable as an iconic representation of the caller or callee that could be rendered informationally by a user agent when a message has been received, or persistently while a dialog takes place.
 * <li>alert - indicates that the body part contains information, such as an audio clip, that should be rendered by the user agent in an attempt to alert the user to the receipt of a request, generally a request that initiates a dialog.
 * </ul>
...
public interface ContentDispositionHeader extends Parameters, Header {
	 ...
	 *
	 * @param dispositionType the new String value of the disposition type.
	 * @throws ParseException which signals that an error has been reached unexpectedly while parsing the dispositionType parameter.
	 */
	 ...
	 *
	 * @param handling the new String value either "optional" or "required".
	 * @throws ParseException which signals that an error has been reached unexpectedly while parsing the handling parameter.
	 */
