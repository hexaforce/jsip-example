 ...
 * <p>
 * The Alert-Info header field can introduce security risks, which are identical to the Call-Info header field risk, see section 20.9 of <a href = "http://www.ietf.org/rfc/rfc3261.txt">RFC3261</a>. In addition, a user SHOULD be able to disable this feature selectively. This helps prevent disruptions that could result from the use of this header field by untrusted elements.
 * <p>
 * For Example:<br>
...
public interface AlertInfoHeader extends Parameters, Header {
	...
	/**
	 * Sets the AlertInfo of the AlertInfoHeader to the <var>alertInfo</var> parameter value.
	 *
