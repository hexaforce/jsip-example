...
/**
 * This interface represents the Event SIP header, as defined by <a href = "http://www.ietf.org/rfc/rfc3265.txt">RFC3265</a>, this header is not part of RFC3261.
 * <p>
 ...
 * <ul>
 * <li>contains an opaque token which identifies the specific subscription within a dialog.
 * <li>is only valid within the scope of a single dialog.
 * <li>if contained in the initial SUBSCRIBE message on the "Event" header, then refreshes of the subscription must also contain an identical "id" parameter, they will otherwise be considered new subscriptions in an existing dialog.
 * <li>if present in the SUBSCRIBE message, that "id" parameter MUST also be present in the corresponding NOTIFY messages.
 * </ul>
...
public interface EventHeader extends Parameters, Header {
	 ...
	 *
	 * @param eventType - the new string defining the eventType supported in this EventHeader
	 ...
	 * @throws ParseException which signals that an error has been reached unexpectedly while parsing the eventId value.
	 */
