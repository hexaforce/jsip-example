...
/**
 * This interface provides factory methods that allow an application to create Header object from a particular implementation of JAIN SIP. This class is a singleton and can be retrieved from the {@link javax.sip.SipFactory#createHeaderFactory()}.
 *
...
public interface HeaderFactory {
	 ...
	 *
	 * @deprecated Since 1.2. Use {@link #createCSeqHeader(long, String)} method with type long.
	 */
	 ...
	 * @throws ParseException which signals that an error has been reached unexpectedly while parsing the headers value or a List of that Header type is not allowed.
	 ...
	 * @throws InvalidArgumentException if supplied majorVersion or minorVersion is less than zero.
	 ...
	 * @throws InvalidArgumentException if supplied cause is less than zero.
	 ...
	 * @throws ParseException which signals that an error has been reached unexpectedly while parsing the List of product values.
	 ...
	 * @throws ParseException           which signals that an error has been reached unexpectedly while parsing the host, transport or branch value.
