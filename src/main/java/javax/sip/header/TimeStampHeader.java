...
public interface TimeStampHeader extends Header {
	 ...
	 * @throws InvalidArgumentException if the timestamp value argument is a negative value.
	...
	/**
	 * Gets delay of TimeStampHeader. This method returns <code>-1</code> if the delay parameter is not set.
	 * 
	 ...
	 * @throws InvalidArgumentException if the delay value argumenmt is a negative value other than the default value <code>-1</code>.
