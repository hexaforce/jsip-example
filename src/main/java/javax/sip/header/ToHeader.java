...
public interface ToHeader extends HeaderAddress, Parameters, Header {
	 ...
	 *
	 * @return the tag parameter of the ToHeader. Returns null if no Tag is present, i.e no dialogue is established.
	 */
	 ...
	 * @return <code>true</code> if <code>obj</code> is an instance of this class representing the same ToHeader as this, <code>false</code> otherwise.
	 * @since v1.2
	 */
