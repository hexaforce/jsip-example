 ...
 * <p>
 * 
 * If no AcceptHeader is present in a Request, the server SHOULD assume a media of type "application" and subType
 * 
...
public interface AcceptHeader extends MediaType, Parameters, Header {
	...
	/**
	 * Sets q-value for media-range in AcceptHeader. Q-values allow the user to indicate the relative degree of preference for that media-range, using
	 * 
