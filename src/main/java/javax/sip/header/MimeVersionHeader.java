...
/**
 * SIP messages MAY include a single MIME-Version general-header field to indicate what version of the MIME protocol was used to construct the message. Use of the MIME-Version header field indicates that the message is in full compliance with the MIME protocol as defined in <a href = "http://www.ietf.org/rfc/rfc2405.txt">RFC2045</a>. Proxies/gateways are responsible for ensuring full compliance (where possible) when exporting SIP messages to strict MIME environments.
 * <p>
 * For Example:<br>
