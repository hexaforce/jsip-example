 ...
 * </ul>
 * <li><b>2xx: Success</b> -- the action was successfully received, understood, and accepted.
 * <li><b>3xx: Redirection</b> -- further action needs to be taken in order to complete the request; 3xx responses give information about the user's new location, or about alternative services that might be able to satisfy the call.
 * <li><b>4xx: Client Error</b> -- the request contains bad syntax or cannot be fulfilled at this server; 4xx responses are definite failure responses from a particular server. The client SHOULD NOT retry the same request without modification. However, the same request to a different server might be successful.
 * <li><b>5xx: Server Error</b> -- the server failed to fulfill an apparently valid request; 5xx responses are failure responses given when a server itself has erred.
 * <li><b>6xx: Global Failure</b> -- the request cannot be fulfilled at any server; 6xx responses indicate that a server has definitive information about a particular user, not just the particular instance indicated in the Request-URI.
 * </ul>
 * SIP status codes are extensible. The response codes are consistent with, and extend, <a href = "http://www.ietf.org/rfc/rfc2616.txt">HTTP/1.1</a> response codes. Not all HTTP/1.1 response codes are appropriate, and only those that are appropriate are given here. Other HTTP/1.1 response codes SHOULD NOT be used. Also, SIP defines a new class, 6xx.
 * <p>
 ...
 * <p>
 * This specification supports the response codes defined in RFC3261 and also the response code extensions for the event notification framework and PUBLISH, documented in <a href = "http://www.ietf.org/rfc/rfc3262.txt">RFC3265</a> and <a href = "http://www.ietf.org/rfc/rfc3909.txt">RFC3909</a>, these are highlighted in italic. Class status codes (x00, i.e. 100) are are highlighted in bold.
 * </p>
 ...
 * <LI>QUEUED - 182</LI>
 * <li>SESSION_PROGRESS - 183</li></td>
 * </tr>
 * <tr>
 * <td>SUCCESS (2xx)</td>
 * <td>
 * <LI><b>OK - 200</b></LI>
 * <LI><i>ACCEPTED - 202 (Extension RFC3265)</i></LI></td>
 * </tr>
 * <tr>
 ...
 * <LI>USE_PROXY - 305</LI>
 * <LI>ALTERNATIVE_SERVICE - 380</LI></td>
 * </tr>
 * <tr>
 ...
 * <LI>SESSION_NOT_ACCEPTABLE - 606</LI></td>
 * </tr>
 * </table>
 *
...
public interface Response extends Message {
	 ...
	 * @throws ParseException which signals that an error has been reached unexpectedly while parsing the statusCode value.
	 */
	 ...
	 * @throws ParseException which signals that an error has been reached unexpectedly while parsing the reasonPhrase value.
	 */
