...
/**
 * A SIP Request is a request from a client to a server. The following Requests method names are defined by <a href = "http://www.ietf.org/rfc/rfc3261.txt"> RFC3261</a>:
 * <ul>
 * <li>ACK - confirms that client has received a final Response to an INVITE Request.
 * <li>BYE - indicates to the server that client wishes to release the call leg.
 * <li>CANCEL - cancels a pending User Agent Client Request.
 * <li>INVITE - indicates that user or service is being invited to participate in a session.
 * <li>OPTIONS - queries a server with regards to its capabilities.
 * <li>REGISTER - registers contact information with a SIP server.
 * </ul>
 *
 * This specifications also supports the following method name extensions, documented in the following standards track RFCs:
 * <ul>
 * <li>INFO - used to carry session related control information that is generated during a session. This functionality is defined in <a href = "http://www.ietf.org/rfc/rfc2976.txt">RFC2976</a>.
 * <li>PRACK - similiar in operation to ACK, however specific to the reliability of provisional Responses. This functionality is defined in <a href = "http://www.ietf.org/rfc/rfc3262.txt">RFC3262</a>.
 * <li>UPDATE - allows a client to update parameters of a session without impacting the state of a dialog. This functionality is defined in <a href = "http://www.ietf.org/rfc/rfc3311.txt">RFC3311</a>.
 * <li>SUBSCRIBE - provides an extensible framework by which SIP nodes can request notification from remote nodes indicating that certain events have occurred. This functionality is defined in <a href = "http://www.ietf.org/rfc/rfc3265.txt">RFC3265</a>.
 * <li>NOTIFY - provides an extensible framework by which SIP nodes can get notification from remote nodes indicating that certain events have occurred. This functionality is defined in <a href = "http://www.ietf.org/rfc/rfc3265.txt">RFC3265</a>.
 * <li>MESSAGE - for sending instant messages using a metaphor similar to that of a two-way pager or SMS enabled handset. This functionality is defined in <a href = "http://www.ietf.org/rfc/rfc3428.txt">RFC3428</a>.
 * <li>REFER - requests that the recipient REFER to a resource provided in the request. This functionality is defined in <a href = "http://www.ietf.org/rfc/rfc3515.txt">RFC3515</a>.
 * <li>PUBLISH - for publishing event state. This functionality is defined in <a href = "http://www.ietf.org/rfc/rfc3903.txt">RFC3903</a>.
 * </ul>
