 ...
 * <li>Convenience header accessor methods for the body content type, language, disposition and length.
...
// Generic header methods of the Message
	 ...
	 * <p>
	 * Required Headers that are singletons should not be added to the message as they already exist in the message and therefore should be changed using the {@link Message#setHeader(Header)} method.
	 * <p>
	 ...
	 * <p>
	 * Required Headers that are singletons should not be added to the message as they already exist in the message and therefore should be changed using the {@link Message#setHeader(Header)} method. This does the same thing as addHeader in all cases including the Via header. Add a header explicitly to the end of a list of headers.
	 *
	 * @param header -- the new Header to be added to the end of the existing list of headers
	 * @throws NullPointerException -- if the argument is null.
	 * @throws SipException         -- if the header is a singleton and an instance of the header already exists.
	 * @since v1.2
	 */
	 ...
	 * Required Headers that are singletons should not be added to the message as they already exist in the message and therefore should be changed using the {@link Message#setHeader(Header)} method.
	 *
	 * @throws SipException         -- if the header to be added is a singleton and an instance of the header already exists.
	 * @throws NullPointerException -- if the argument is null.
	 * @param header the new Header to be added to the existing Headers List.
	 * @since v1.2
	 */
	...
	/**
	 * Removes the Header of the supplied name from the list of headers in this Message. If multiple headers exist then they are all removed from the header list. If no headers exist then this method returns silently. This method should not be used to remove required Headers, required Headers should be replaced using the {@link Message#setHeader(Header)}.
	 *
	 ...
	 * @return the ListIterator over all the Headers of the specified name in the Message, this method returns an empty ListIterator if no Headers exist of this header type.
	 */
	 ...
	 * @return the Header of the specified name in the Message, this method returns null if the Header does not exist.
	 */
	 ...
	 *
	 * @return the ListIterator over all the UnrecognizedHeaders in the Message represented as Strings, this method returns an empty ListIterator if no UnrecognizedHeaders exist.
	 */
...
// Content manipulation methods of the Message
	 ...
	 *
	 * @param contentLength the new ContentLengthHeader object containing the content length value of this Message.
	 *
	 */
	public void setContentLength(ContentLengthHeader contentLength);

	/**
	 * Gets the ContentLengthHeader of the body content of this Message. This is the same as <code>this.getHeader(Content-Length);</code>
	 *
	 ...
	 *
	 * @param contentLanguage the new ContentLanguageHeader object containing the content language value of this Message.
	 */
	public void setContentLanguage(ContentLanguageHeader contentLanguage);

	/**
	 * Gets the ContentLanguageHeader of this Message. This is the same as <code>this.getHeader(Content-Langauge);</code>
	 *
	 ...
	 *
	 * @param contentEncoding the new ContentEncodingHeader object containing the content encoding values of this Message.
	 */
	public void setContentEncoding(ContentEncodingHeader contentEncoding);

	/**
	 * Gets the ContentEncodingHeader of this Message. This is the same as <code>this.getHeader(Content-Encoding);</code>
	 *
	 ...
	 *
	 * @param contentDisposition the new ContentDispositionHeader object containing the content disposition value of this Message.
	 */
	public void setContentDisposition(ContentDispositionHeader contentDisposition);

	/**
	 * Gets the ContentDispositionHeader of this Message. This is the same as <code>this.getHeader(Content-Disposition);</code>
	 *
	 ...
	 * @param contentTypeHeader the new ContentTypeHeader object that defines the content type value.
	 * @throws ParseException which signals that an error has been reached unexpectedly while parsing the body.
	 */
	 ...
	 *
	 * @return the body content of the Message as a byte array, this method returns null if a body does not exist.
	 */
	 ...
	 *
	 * @return the body content of the Message as an Object, this method returns null if a body does not exist.
	 */
...
// Additional Utility methods
	...
	/**
	 * Gets the ExpiresHeader of this Message. This is the same as <code>this.getHeader(Expires);</code>
	 *
	 ...
	 *
	 * @param version the new String object containing the version of the SIP Protocol of this Message.
	 * @throws ParseException which signals that an error has been reached unexpectedly while parsing the version argument.
	 */
...
// Java Utility methods for Message
	...
	/**
	 * Creates and returns a deep copy of the Message. This methods must ensure a deep copy of the message, so that it can be modified without effecting the original message. This provides useful functionality for proxying Requests and Responses, for example:
	 * <ul>
	 ...
	 * <ul>
	 * <li>If the content is of type byte[] a new byte[] array is allocated and the original contents are copied over to the cloned Message.
	 * <li>If the content is of type String then a new String equal to the old String is allocated and assigned to the cloned Message.
	 * <li>If the content is of type Object and it has a public clone method then it is invoked and the resultant Object is used in the new cloned Message.
	 * </ul>
	 *
	 ...
	 * @return <code>true</code> if <code>obj</code> is an instance of this class representing the same SIP Message as this (on the basis of comparing the headers above), <code>false</code> otherwise.
	 */
