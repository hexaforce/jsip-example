...
/**
 * This interface provides factory methods that allow an application to create Request and Response messages from a particular implementation of JAIN SIP. This class is a singleton and can be retrieved from the {@link javax.sip.SipFactory#createMessageFactory()}.
 *
...
// generic create message method
	 ...
	 * @return the newly created Request object.
	 * @throws ParseException which signals that an error has been reached unexpectedly while parsing the request.
	 */
...
// Response Creation methods based on a Request
	 ...
	 *
	 * @param response is a string representing the response. The argument should only contain the Sip Headers and not the body of the response.
	 * @throws ParseException which signals an error has been reached unexpectedly while parsing the response.
	 * @since v1.2
	 *
	 */
