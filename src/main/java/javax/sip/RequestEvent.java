 ...
 * <ul>
 * <li>source - the source of the event i.e. the SipProvider sending the RequestEvent
 * <li>serverTransaction - the server transaction this RequestEvent is associated with.
 * <li>Request - the Request message received on the SipProvider that needs passed to the application encapsulated in a RequestEvent.
 * </ul>
 *
...
public class RequestEvent extends EventObject {
	...
	/**
	 * Constructs a RequestEvent encapsulating the Request that has been received by the underlying SipProvider. This RequestEvent once created is passed to {@link javax.sip.SipListener#processRequest(RequestEvent)} method of the SipListener for application processing.
	 *
