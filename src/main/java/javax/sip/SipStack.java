 ...
 * <p>
 * This SipStack interface defines the methods that are be used by an application implementing the {@link javax.sip.SipListener} interface to control the architecture and setup of the SIP stack. These methods include:
 * <ul>
 * <li>Creation/deletion of {@link javax.sip.SipProvider}'s that represent messaging objects that can be used by an application to send {@link javax.sip.message.Request}and {@link javax.sip.message.Response} messages statelessly or statefully via Client and Server transactions.
 * <li>Creation/deletion of {@link javax.sip.ListeningPoint}'s that represent different ports and transports that a SipProvider can use to send and receive messages.
 * </ul>
 * <b>Architecture: </b> <br>
 ...
 * <td align="left" valign="top">
 * <p class="table">
 * <b>Deprecated v1.2.</b> Applications can request retransmission alerts from the {@link ServerTransaction#enableRetransmissionAlerts()}.
 * <p>
 ...
 * <ul>
 * <li>User Agent Client: Retransmissions of ACK Requests are the responsibility of the application. All other retansmissions are handled by the SipProvider.
 ...
 * </p>
 * </td>
 * <td align="left" valign="top">This property specifies the defined values 'ON' and 'OFF'. The default value is 'ON'. The default behavior represents a common mode of stack operation and allows the construction of simple user agents. This property is optional. This is summarized as:</li>
 * <ul>
 ...
 * <li>The first 2xx response to the transaction will drive the dialog to the CONFIRMED state.</li>
 * </ul>
 * </ul>
 * <blockquote>The ability to turn of dialog support is motivated by dialog free servers (such as proxy servers) that do not want to pay the overhead of the dialog layer and user agents that may want to create multiple dialogs for a single INVITE (as a result of forking by proxy servers). The following behavior is defined when the configuration parameter is set to 'OFF'.
 * <ul type="circle">
 * <li>The application is responsible to create the Dialog if desired.</li>
 * <li>The application may create a Dialog and associate it with a response (provisional or final) of a dialog creating request.&nbsp;</li>
 * </ul>
 * </blockquote> <b>Since v1.2.</b></td>
 * </tr>
 *
 * <tr>
 * <td align="left" valign="top">
 ...
 * <td align="left" valign="top">
 * <p class="table">
 * Comma separated list of events for which the implementation should expect forked SUBSCRIBE dialogs. Each element of this list must have the syntax packagename.eventname
 *
 * This configuration parameter is provided in order to support the following behavior ( defined in RFC 3265):
 *
 ...
 *
 * If multiple NOTIFY messages are received in different dialogs in response to a single SUBSCRIBE message, each dialog represents a different destination to which the SUBSCRIBE request was forked.
 *
...
public interface SipStack {
	 ...
	 * @throws ObjectInUseException if another SipProvider is already associated with this ListeningPoint.
	 ...
	 *
	 * @param sipProvider the peer SipProvider to be deleted from this SipStack.
	 * @throws ObjectInUseException if the specified SipProvider cannot be deleted because the SipProvider is currently in use.
	 *
	 */
	 ...
	 * @throws TansportNotSupportedException if the specified transport is not supported by this SipStack.
	 * @throws InvalidArgumentException      if the specified port is invalid.
	 *
	 * @deprecated Since v1.2. This has been replaced by {@link SipStack#createListeningPoint(String, int, String) } For backwards compatibility with v1.1 implementations should support this method. Implementations should throw <it>TransportNotSupportedException</it> if the Properties specified during stack creation do not include an IP Address.
	 */
	 ...
	 * @throws SipException             if the Listening point cannot be created for any reason or if the stack has specified a default IP address that differs from the IP address specified for this method.
	 ...
	 * @throws ObjectInUseException if the specified ListeningPoint cannot be deleted because the ListeningPoint is currently in use.
	 */
	 ...
	 *
	 * @return an Iterator containing all existing ListeningPoints created by this SipStack. Returns an empty Iterator if no ListeningPoints exist.
	 */
	...
	/**
	 * Gets the user friendly name that identifies this SipStack instance. This value is set using the Properties object passed to the {@link SipFactory#createSipStack(Properties)}method upon creation of the SipStack object.
	 *
	...
	/**
	 * Gets the IP Address that identifies this SipStack instance. Every SipStack object may have an IP Address. This specification recommends associating the IP address with the {@link ListeningPoint}. For backwards compatability if an IP address is specified in the Properties object passed to the {@link SipFactory#createSipStack(Properties)} method upon creation of the SipStack object then this becomes the default IP address of the SipStack object, ListeningPoints can then be created on this IP Address.
	 *
	 * @return a string identifing the IP Address. Null if there is no default IP address associated with the stack instance.
	 */
	public String getIPAddress();

	/**
	 * Gets the Router object that identifies the default Router information of this SipStack. This value is set using the Properties object passed to the {@link SipFactory#createSipStack(Properties)}method upon creation of the SipStack object.
	 *
	 ...
	 *
	 * @throws SipException if the stack cannot be started due to some system level failure.
	 *
	 * @since 1.2
	 */
	...
	/**
	 * This method returns the value of the retransmission filter helper function for User Agent applications. This value is set using the Properties object passed to the {@link SipFactory#createSipStack(Properties)}method upon creation of the SipStack object.
	 * <p>
	 * The default value of the retransmission filter boolean is <var>false </var>. When this value is set to <code>true</code>, retransmissions of ACK's and 2xx responses to an INVITE transaction are handled by the SipProvider, hence the application will not receive {@link Timeout#RETRANSMIT}notifications encapsulated in {@link javax.sip.TimeoutEvent}'s, however an application will be notified if the underlying transaction expires with a {@link Timeout#TRANSACTION}notification encapsulated in a TimeoutEvent.
	 *
	 * @deprecated Since v1.2. This retransmission filter property has been deprecated as a SIP Stack property. Applications can enable retransmission alerts by using the {@link ServerTransaction#enableRetransmissionAlerts()} method.
	 *
	 * @return the value of the retransmission filter, <code>true</code> if the filter is set, <code>false</code> otherwise.
	 */
