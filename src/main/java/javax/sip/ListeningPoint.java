...
public interface ListeningPoint extends Cloneable, Serializable {
	 ...
	 * <ul>
	 * <li>The default port is 5060, if the transport UDP and the scheme is <i>sip:</i>.
	 * <li>The default port is 5060, if the transport is TCP and the scheme is <i>sip:</i>.
	 * <li>The default port is 5060, if the transport is SCTP and the scheme is <i>sip:</i>.
	 * <li>The default port is 5061, if the transport is TLS over TCP and the scheme is <i>sip:</i>.
	 * <li>The default port is 5061, if the transport is TCP and the scheme is <i>sips:</i>.
	 * </ul>
	 *
	 ...
	 * @throws ParseException which signals that an error has been reached unexpectedly while parsing the sentBy value.
	 * @since v1.2
	 */
