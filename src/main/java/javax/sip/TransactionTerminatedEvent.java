...
public class TransactionTerminatedEvent extends EventObject {
	 ...
	 *
	 * @return server transaction associated with this TransactionTerminatedEvent, or null if this event is specific to a client transaction.
	 */
	 ...
	 *
	 * @return client transaction associated with this TransactionTerminatedEvent, or null if this event is specific to a server transaction.
	 */
