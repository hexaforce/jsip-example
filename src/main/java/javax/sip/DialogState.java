...
public final class DialogState implements Serializable {
	 ...
	 *
	 * This method would be used when for example serializing DialogState.EARLY and deserializing it afterwards results again in DialogState.EARLY. If you do not implement readResolve(), you would not get DialogState.EARLY but an instance with similar content.
	 *
	 ...
	 * @return <code>true</code> if <code>obj</code> is an instance of this class representing the same dialog state as this, <code>false</code> otherwise.
	 */
	...
	/**
	 * This constant value indicates the internal value of the "Early" constant. <br>
	...
	/**
	 * This constant value indicates the internal value of the "Confirmed" constant. <br>
	...
	/**
	 * This constant value indicates the internal value of the "Completed" constant. <br>
	...
	/**
	 * This constant value indicates the internal value of the "Terminated" constant. <br>
