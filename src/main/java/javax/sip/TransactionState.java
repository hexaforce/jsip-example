...
/**
 * 
 * This class contains the enumerations that define the underlying state of an existing transaction. SIP defines four types of
 * 
...
public final class TransactionState implements Serializable {
	 ...
	 * @return <code>true</code> if <code>obj</code> is an instance of this class representing the same transaction state as this, <code>false</code> otherwise.
	 */
	...
	/**
	 * This constant value indicates the internal value of the "Calling" constant. <br>
	...
	/**
	 * This constant value indicates the internal value of the "Proceeding" constant. <br>
