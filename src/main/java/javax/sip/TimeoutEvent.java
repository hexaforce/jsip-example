 ...
 * <li>isServerTransaction - boolean indicating whether the transaction refers to a client or server transaction.
...
public class TimeoutEvent extends EventObject {
	 ...
	 * @param timeout           - indicates if this is a retranmission or transaction timeout event.
	 */
	 ...
	 *
	 * @return server transaction associated with this TimeoutEvent, or null if this event is specific to a client transaction.
	 */
	 ...
	 *
	 * @return client transaction associated with this TimeoutEvent, or null if this event is specific to a server transaction.
	 */
	 ...
	 *
	 * @return returns true if a server transaction or false if a client transaction.
	 */
