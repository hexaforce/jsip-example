...
/**
 * This interface provides factory methods that allow an application to create Address objects, URI's, SipURI's and TelURL's from a particular implementation of this specification. This class is a singleton and can be retrieved from the {@link javax.sip.SipFactory#createAddressFactory()}.
 *
...
public interface AddressFactory {
	 ...
	 * <li>The scheme followed by a colon character ('sip:') is appended to the result.
	 * <li>The user and host are then appended. Any character that is not a legal URI character is quoted.
	 * </ul>
	 * <br>
	 ...
	 * <p>
	 * An application that wishes to create a 'sips' URI should call the {@link SipURI#setSecure(boolean)} with an argument of 'true' on the returned SipURI.
	 *
	 ...
	 * @throws ParseException which signals that an error has been reached unexpectedly while parsing the address value.
	 */
	 ...
	 *
	 * @param displayName - the new string value of the display name of the address. A <code>null</code> value does not set the display name.
	 * @param uri         - the new URI value of the address.
	 * @throws ParseException which signals that an error has been reached unexpectedly while parsing the displayName value.
	 */
