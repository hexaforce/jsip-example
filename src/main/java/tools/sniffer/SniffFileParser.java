 ...
 *
 *         Acknowledgement: This code was contributed by Tim Bardzil <bardzil@colorado.edu>. This code was completed as part of a class project in TLEN 5843 Singaling Protocols, taught by Professor Douglas C. Sicker, Ph.D. at the University of Colorado, Boulder. Minor modifications to the code were made by M. Ranganathan .
 *
 */
public class SniffFileParser {
	...
	public SniffFileParser(String messageFile) {
		...
		try {
			...
			while (buffer != null) { // read until EOF
				...
				while (buffer != null && buffer.length() > 0) { // read one frame
	 ...
	 *
	 * @param args is the argument file. args[0] is the Ethereral packet sniffer output to convert to the format that the trace viewer likes.
	 */
	public static void main(String args[]) {
		...
		new TracesViewer(traces, fileName, "Ethereal Sniffer Trace", null).show();
