...
public class CircleArrow extends Arrow {
	...
	public CircleArrow(boolean selected, String arrowName, int x, int ymin, int ymax, int diameter, boolean flag, boolean info) {
	...
	public void draw(Graphics g) {
		...
		g.drawString(tracesMessage.getFirstLine(), x + diameter + 5 + tracesCanvas.HORIZONTAL_GAP / 2 - fistLineStringWidth / 2, y - 5);

		g.drawString(timeString, x + diameter + 5 + tracesCanvas.HORIZONTAL_GAP / 2 - timeStringWidth / 2, y + g.getFontMetrics(g.getFont()).getHeight());
