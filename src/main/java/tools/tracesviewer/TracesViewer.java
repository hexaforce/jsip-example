...
public class TracesViewer extends javax.swing.JFrame {
	 ...
	 *
	 */
	public TracesViewer(Hashtable traces, String logName, String logDescription, String auxInfo) {
	...
	public TracesViewer(String title, String aRmiHost, String aRmiPort, String aStackId) {
		super(title);
		try {
			/*
			 * Toolkit toolkit=Toolkit.getDefaultToolkit(); backgroundImage=toolkit.getImage("./images/back.gif"); actorsImage=toolkit.getImage("./images/comp.gif"); facesImage=toolkit.getImage("./images/faces.jpg"); logoNist=toolkit.getImage("./images/nistBanner.jpg");
			 */
	...
	public TracesViewer(String title, String aRmiHost, String aRmiPort, String aStackId, String back, String faces, String actors, String aLogoNist) {
		super(title);
		try {
			Toolkit toolkit = Toolkit.getDefaultToolkit();
	...
	// Constructor for the Application only!!!!!
	public TracesViewer(String logFile, Hashtable traces, String logName, String logDescription, String auxInfo, String title, String back, String faces, String actors, String aLogoNist) {
		super(title);
		...
		try {
			...
			/*
			 * Toolkit toolkit=Toolkit.getDefaultToolkit(); backgroundImage=toolkit.getImage(back); actorsImage=toolkit.getImage(actors); facesImage=toolkit.getImage(faces); this.logoNist=logoNist;
			 */
		} catch (Exception e) {
			backgroundImage = null;
			actorsImage = null;
	 ...
	 */
	public TracesViewer(String title, String logFile, String back, String faces, String actors, String logoNist) {
		super(title);
		this.logFile = logFile;
		listenerTracesViewer = new ListenerTracesViewer(this);
	...
	public TracesViewer(String port, String logFile, Hashtable traces, String logName, String logDescription, String auxInfo, String title, String back, String faces, String actors, String aLogoNist) {
		super(title);
		this.logFile = logFile;
	...
	private void initComponents() {
		...
		displayAllSessionsMenu.setToolTipText("Display all the retrieved sessions in a separate windows");
	...
	public static void main(String args[]) {
		try {
			if (args.length == 0) {
				...
				new TracesViewer(fileName, traces, parser.logName, parser.logDescription, parser.auxInfo, "traces viewer", "images/back.gif", "images/faces.jpg", "images/comp.gif", "images/nistBanner.jpg").show();
				...
				new TracesViewer(port, fileName, traces, parser.logName, parser.logDescription, parser.auxInfo, "traces viewer daemon", "images/back.gif", "images/faces.jpg", "images/comp.gif", "images/nistBanner.jpg").show();
				...
				if (launcher)
					tracesViewer = new TracesViewer("Traces viewer", rmiHost, rmiPort, stackId, back, faces, actors, logoNist);
				else
