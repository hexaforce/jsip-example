...
public class LogFileParser extends DefaultHandler {
	...
	public void endElement(String namespaceURI, String sName, // simple name
		...
		if (qName.equalsIgnoreCase("message")) {
			...
			messageLog = new TracesMessage(from, to, time, firstLine, message.toString(), statusMessage, transactionId, messageTimeStamp, debugLine);

			MessageLogList messageLogList = (MessageLogList) messageLogs.get(callId);
