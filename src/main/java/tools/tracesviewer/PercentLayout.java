 ...
 *
 * Each Component added to the Container must have a Constraint object that specifies what proportion of the container it will fill. The Component will be stretched to fill exactly that percentage.
 *
 * @see Constraint
 */
public class PercentLayout implements LayoutManager2 {
	...
	public Dimension preferredLayoutSize(Container p1) {
		...
		while (keys.hasMoreElements()) {
			...
			PercentLayoutConstraint constraint = (PercentLayoutConstraint) hash.get(comp);
